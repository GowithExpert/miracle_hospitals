		...
		<div class="row">
			...
			<div class="col l8 m8 s12">
				<div class="card" style="box-shadow: none;">
					...
					<div class="card-content">
						<?= form_open('Patients/clear_final_dues/' . $patients[0]->id .'/'. $patients[0]->pid .'/'. $patients[0]->apmt_id .'/'. $patients[0]->puid); ?>
						<!-- Start-Custom -->
						<div class="row">
							...
							<div class="col l8 m8 s11">									
								...
								?>
								<input type="number" name="total_hospital_expenses" class="readonly_bg" id="total_hospital_expenses" placeholder="Total Expense" readonly value="<?= $total_expenses_value === 0 ? '0.00' : $formatted_value; ?>">
								<?php if (isset($validation)) { ?>
									<span style="color: red"><?= display_error($validation, 'total_expenses'); ?></span>
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
								...
								<div class="input-container">
									<input type="number" name="total_paid_amount" class="asterisk over_error" id="total_paid_amount" placeholder="Enter Total Patient Paid Amount" value="<?= $total_payable === 0 ? '0.00' : $patient_paid_amount; ?>">
									<span class="asterisk-symbol">*</span>
								</div>
								<?php if (isset($validation)) { ?>
									<span style="color: red"><?= display_error($validation, 'patient_paid'); ?></span>
									<?= $validation->listErrors(); ?>
								<?php } ?>
							</div>
							<div class="col l1 m1 s1">
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
							<div class="input-container">
								<input type="text" name="dues_amount" class="asterisk over_error text_align" id="dues_amount" placeholder="0.00" value="<?= $total_pay_amt[0]->paid_amount - $total_expnc_amt[0]->total_price; ?>">
								<span class="asterisk-symbol">*</span>
							</div>
								<?php if (isset($validation)) { ?>
									<span style="color: red"><?= display_error($validation, 'dues_amount'); ?></span>
									<?= $validation->listErrors(); ?>
								<?php } ?>
							</div>
