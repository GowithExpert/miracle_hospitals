...
<body class="patient_back">
	...
	<div class="row" id="mrg_top">
		...
		<div class="col l4 m12 s12">
			<!---card Section --->
			<?= form_open('Patients_login/login'); ?>
			<div class="card">
				<!---Php Meassge Show --->
				<div class="reltiv">
					<?php
				...
				<div class="card-content brdr_rdius" id="login_id_with_image">
					<h4 class="center-align h4_mrhn"><span class="fa fa-wheelchair fa_icon"></span></h4>
					<h5 class="center-align log_pge_hedng">Patient Login</h5>
					...
					<div class="input-container">
						<input type="text" name="email" id="email" class="emailInput inpt_area" maxlength="40" placeholder="Email address" value="<?= set_value('email'); ?>" autocomplete="off">
                    ...
                    <div class="input-container">
						...
						<div class="password-container">
							<div class="image">
								<input type="password" name="password" class="passwordInput inpt_area" id="input_box" minlength="6" maxlength="20" placeholder="Password" value="<?= set_value('password'); ?>" autocomplete="off">
					...
					<a href="<?= base_url('Patients_login/forget_password'); ?>" class="forgot_pass_btn">Forget Password ?</a>

					<p class="new_user_btn">New User?<a href="<?= base_url('Patients_login/register'); ?>" class="cret_acc_btn"> Create Account</a></p>

					<h6 class="h6_notes_doctor">Notes:</h6>
					<p class="login_para_1">Hospital Management Software Login Panel </p>
					<p class="login_para_2">Patient Login will Manage All Activity Of Patient</p>
