				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="input-container">
							<input type="password" name="old_password" minlength="6" maxlength="20" class="asterisk input_box" id="old_password" value="<?= set_value('old_password'); ?>" placeholder="Old Password">
					...
					<div class="col-lg-12 col-md-12 col-sm-12">
						...
						<div class="password-container">
							<div class="image">
							<div class="input-container">
								<input type="password" name="new_password" class="asterisk passwordInput input_box" minlength="6" maxlength="20" class="passwordInput" value="<?= set_value('new_password'); ?>" id="new_password" placeholder="Enter New Password">
								<span class="asterisk-symbol">*</span>
							</div>
