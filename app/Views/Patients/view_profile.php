                                    ...
                                    <div class="user-avatar" id="avatar-container">
                                        ...
                                        <?php
											if (isset($profile_record->profile_pic) && !empty($profile_record->profile_pic)) {
												if (file_exists(FCPATH . 'uploads/patients/' . $profile_record->profile_pic)) { ?>
													<img src="<?= base_url() . 'public/uploads/patients/' . $profile_record->profile_pic; ?>" class="responsive-img" name="profile_pic" id="profile_pic">

												<?php  } //Inner if - Closed
												else {  ?>
													<img src="<?= base_url() . 'public/assets/images/patient_default.svg'; ?>" class="user-avatar" id="avatar-container">
                            ...
                            <div class="row gutters">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    ...
                                    <div class="input-container">
                                        <input type="text" name="username" class="input asterisk form-control user-email emailError fullName input_box" id="username" value="<?=$profile_record->username?>"placeholder="Enter Full Name">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="email" class="input asterisk form-control user-email emailError eMail input_box" name="email" id="email"value="<?=$profile_record->email?>" placeholder="Enter email ID">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="tel" class="asterisk input form-control phone-input phoneError phone input_box mobile phone_mandatory" name="mobile" maxlength="10" id="mobile" value="<?=$profile_record->mobile?>" placeholder="Enter phone number">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="text" class="input asterisk form-control ageError age input_box" name="gender" id="gender" value="<?=$profile_record->gender?>" placeholder="Enter Gender">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                            ...
                            <div class="row gutters">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="name" class="input asterisk form-control streetError Street input_box" name="country" id="country" value="<?=$profile_record->country?>" placeholder="Enter Country">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="text" class="input asterisk form-control stateError sTate input_box" name="state" id="state" value="<?=$profile_record->state?>" placeholder="Enter State">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="name" class="input asterisk form-control cityError ciTy input_box" name="city" id="city" value="<?=$profile_record->city?>" placeholder="Enter City">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="text" class="input asterisk form-control stateError sTate input_box" name="address" id="address" value="<?=$profile_record->address?>" placeholder="Enter Address">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                                    <span id="stateError" class="col_red"></span>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="number" class="input asterisk form-control pinError zIp input_box" name="pinzip" id="pinzip"value="<?=$profile_record->pinzip; ?>" placeholder="Enter Pin / Zip Code">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="UniqueIDName">Unique ID Name</label>
                                        <input type="text" class="input form-control pinError zIp input_box" maxlength="120" name="unique_id_name" id="unique_id_name"value="<?=$profile_record->unique_id_name?>" placeholder="Enter Unique ID name(aadhar card, SSN etc)">
                                    </div>
                                    <span id="uniqueError" class="col_red"></span>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="UniqueID">Unique ID</label>
                                        <input type="text" class="input form-control pinError zIp input_box" maxlength="120" name="unique_id" id="unique_id"value="<?=$profile_record->unique_id?>" placeholder="Enter Unique ID (aadhar card, SSN etc)">
                                    </div>
                                    <span id="uniqueError" class="col_red"></span>
                                </div>
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="input form-control pinError zIp input_box" maxlength="120" name="about_me" id="about_me"value="<?=$profile_record->about_me?>" placeholder="Enter About Yourself" >
                                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#browser_file").on("change", function () { //Upload pic on browse file
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('/Patients/upload_profile_pic/') ?>",
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        ...
                        if (jsonResponse && jsonResponse.status === false) {
                            ...
                            showsucesMsg(jsonResponse.message);
                        } else if (jsonResponse && jsonResponse.warning) {
                            showWarningMessage(jsonResponse.message);
                        } else {
            ...
            $("#update-button").on("click", function (e) {
                ...
                var unique_id_name = $("#unique_id_name").val();
                ...
                $.ajax({ //Ajax call - START
                    type: 'POST',
                    url: "<?= base_url('/Patients/update_profile/') ?>",
                    data: {
                        username:username,
                        email:email,
                        mobile:mobile,
