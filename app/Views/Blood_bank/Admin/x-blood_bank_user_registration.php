...
<body class="bld_bnk_backg">
	...
	<div class="row" id="mrg_top1">
		...
		<div class="col l4 m12 s12">
			...
			<?= form_open('Blood_bank_registration/blood_bank_user_registration', array('id' => 'registration_form', 'onsubmit' => 'return updateCountryCode();')); ?>
			<div class="card">
				<div class="card-content brdr_rdius" id="login_id_with_image">
					<h4 class="center-align h4_margn mrg_botm"><span class="fa fa-heartbeat fa_icon"></span></h4>
					<h5 class="center-align h5_margn mrg_botm font_weght">Blood Bank Admin Registration</h5>
					...
					<select name="gender" class="genderSelect inpt_area selct_gndr dis_blk">
					...
					<br>
					<a href="<?= base_url('Blood_bank/blood_bank_login'); ?>" class="btn waves-effect waves-light ihve_alrdy_acc">Already Have An Account?</a>
				</div>
			</div>
			<?= form_close(); ?>
			<!---card Section --->
