...
<body class="admin_login_back">
	...
	<div class="row" id="mrg_top">
		...
		<div class="col l4 m12 s12">
			...
			<?php  
			?>
			<?= form_open('Blood_bank/blood_bank_login/'); ?>
			<div class="card">
				<!---Php Meassge Show --->
				<div class="reltiv">
					<?php
				...
				<div class="card-content brdr_rdius" id="login_id_with_image">
					<h4 class="center-align h4_mrhn"><span class="fa fa-heartbeat fa_icon"></span></h4>
					<h5 class="center-align log_pge_hedng">Blood bank Login</h5>
                    ...
                    <div class="input-container">
						...
						<div class="password-container">
							<div class="image">
								<input type="password" name="password" class="passwordInput inpt_area" id="input_box" minlength="6" maxlength="20" placeholder="Password" value="<?= set_value('password'); ?>">
					...
					<a href="<?= base_url('Blood_bank/forget_password'); ?>" class="forgot_pass_btn">Forget Password ?</a>

					<p class="new_user_btn">New User?<a href="<?= base_url('Blood_bank_registration/blood_bank_user_registration'); ?>" class="cret_acc_btn"> Create Account</a></p>

					<h6 class="h6_notes_doctor">Notes:</h6>
					<p class="login_para_1">Hospital Management Software Login Panel </p>
					<p class="login_para_2">Here ! Blood Bank Accountant Login !</p>
				</div>
			</div>
			<?= form_close(); ?>
			<!---card Section --->
