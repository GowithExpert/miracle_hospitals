				...
				<div class="card brdr_rdius forgt_card_cntnt">
					...
					<div class="card-content">
						<div class="input-container">
							<input type="text" name="email" id="input_box" class="asterisk inpt_area margn_tp" value="<?= set_value('email'); ?>" placeholder="Enter Email Id">
						...
						<br>
						<center>
							<p class="bck_to_logn"><a class="flex" href="<?= base_url('Blood_bank/blood_bank_login'); ?>"><i class="fa fa-angle-left"></i> Back to Login</a></p>
						</center>
					</div>
				</div>
				<?= form_close(); ?>
