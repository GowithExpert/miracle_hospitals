...
<body class="admin_login_back">
	...
	<div class="row" id="mrg_top1">
		...
		<div class="col l4 m12 s12">
			<!---card Section --->
			<!-- <//?= form_open('Frontdesk_login/create_frnd_account'); ?> -->
			<?= form_open('Frontdesk_login/create_frnd_account', array('id' => 'registration_form', 'onsubmit' => 'return updateCountryCode();')); ?>
			<div class="card">
				<!---Php Meassge Show --->
				<div class="reltiv">
					<?php
				...
				<div class="card-content brdr_rdius" id="login_id_with_image">
					...
					<h5 class="center-align h5_margn font_weght">Frontdesk Login</h5>
					...
					<select name="gender" class="genderSelect selct_gendr">
	...
	<script>
		$(document).ready(function() {
			$("#signup-form").on("submit", function(event) {
				...
				window.location.href = "<?= base_url('Frontdesk_login/index') ?>";
			});
