	...
	<div class="container">
		<div class="card">
			<div class="card-content" id="brdr_botm_silvr">
				<h5><span class="fa fa-wheelchair col_blu"></span> Book Appointments</h5>
				<p class="p_content">Fill out all required Field (<span class="star"><sub>*</sub></span>) to add a Patient. Please don't spam,Thank you!</p>
			</div>
			<div class="card-content">
				<?= form_open_multipart('Frontdesk/upload_patients'); ?>
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12">
						<h6><span class="fa fa-user col_blu"></span>  Patient Name</h6>
						...
						<?php if (isset($validation)) { ?>
							<span class="col_red chng_pss_valid1">
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						...
						<div class="input-container">
							<input type="tel" name="patient_phone" class="asterisk phone-input phone_mandatory" id="input_box" maxlength="10" placeholder="Enter Mobile Number" oninput="validateMobile(this)" value="<?= set_value('patient_phone'); ?>">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12">
						<h6><span class="fa fa-globe col_blu"></span>  Patient Age</h6>
						<div class="input-container">
							...
							<span class="asterisk-symbol">*</span>
							<span id="ageError" class="col_red chng_pss_valid1"></span>
						</div>
						<?php if (isset($validation)) { ?>
							<span class="col_red chng_pss_valid1">
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<h6><span class="fa fa-users col_blu"></span>  Select Gender</h6>
						<div class="select-wrapper">
							<select name="patient_gender" class="genderSelect selct_gendr asterisk" id="patient_gender" required>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12">
						<h6><span class="fa fa-globe col_blu"></span>  Disease Symptoms</h6>
						<div class="input-container">
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<h6><span class="fa fa-home col_blu"></span>  Disease Detail</h6>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<h6><span class="fa fa-camera" class="col_red"></span>  Upload Patient Photo</h6>
						<input type="file" name="patient_image" class="asterisk" id="input_file" value="<?= set_value('patient_image'); ?>">
						<?php if (isset($validation)) { ?>
							<span class="col_red chng_pss_valid1">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12">
						<h6><span class="fa fa-users col_blu"></span>  Select Doctor</h6>
						<div class="select-wrapper">
							<select name="doctor_name" class="doctorSelect selct_gendr asterisk genderSelect" id="doctor">
							...
							<span id="doctorError" class="col_red"></span>
						</div>
						<?php if (isset($validation)) { ?>
							<span class="col_red chng_pss_valid1">
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						...
						<select name="doctor_fee" id="doctor_fee" class="selct_gendr doctor_fee">
