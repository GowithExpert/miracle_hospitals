		...
		<div class="row">
			...
			<div class="col l8 m8 s12">
				...
				<div class="card">
					...
					<div class="card-content">
						<?= form_open('Frontdesk/clear_final_dues/' . $patients[0]->id .'/'. $patients[0]->pid .'/'. $patients[0]->apmt_id .'/'. $patients[0]->puid . '/' .$patients[0]->status); ?>
						<!-- Start-Custom -->
						<div class="row">
							...
							<div class="col l8 m8 s11">									
								...
								?>
								<input type="number" name="total_hospital_expenses" class="readonly_bg plachldr_algn" id="total_hospital_expenses" placeholder="Total Expense" readonly value="<?= $total_expenses_value === 0 ? '0.00' : $formatted_value; ?>">
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
								...
								<div class="input-container">
									<input type="number" name="total_paid_amount" class="asterisk over_error readonly_bg plachldr_algn" id="total_paid_amount" placeholder="Enter Total Patient Paid Amount" value="<?= $total_payable === 0 ? '0.00' : $patient_paid_amount; ?>" readonly>
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
							<div class="input-container">
								<input type="text" name="dues_amount" class="asterisk text_align readonly_bg plachldr_algn" id="dues_amount" placeholder="0.00" value="<?= $total_pay_amt - $total_expnc_amt['total_expnc_amt']; ?>" readonly>
								<span class="asterisk-symbol">*</span>
							</div>
								<?php if (isset($validation)) { ?>
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
								<textarea name="payment_note" id="payment_note" class="plachldr_algn" placeholder="Enter Payment Note"></textarea>
							</div>
							<div class="col l1 m1 s1">
