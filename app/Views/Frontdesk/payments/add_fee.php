			...
			<div class="col l8 m8 s12">
				<div class="card">
					...
					<div class="card-content">
						...
						<?= form_open('Frontdesk/save_fee/' . $apmt_patient[0]->patients_id . '/' . $apmt_patient[0]->pid . '/' . $apmt_patient[0]->id . '/' . $apmt_patient[0]->puid . '/' . $apmt_patient[0]->serial . '/' . $apmt_paymnt_payid) ?>
						<div class="row">
