                                    ...
                                    <div class="user-avatar" id="avatar-container">
                                        <?php
											if (isset($profile_record->profile_pic) && !empty($profile_record->profile_pic)) {
												if (file_exists(FCPATH . 'uploads/accounts/frontdesk/' . $profile_record->profile_pic)) { ?>
													<img src="<?= base_url() . 'public/uploads/accounts/frontdesk/' . $profile_record->profile_pic; ?>" class="responsive-img" name="profile_pic" id="profile_pic">

												<?php  } //Inner if - Closed
												else {  ?>
													<img src="<?= base_url() . 'public/assets/images/frontdesk_default_pic.svg'; ?>" class="user-avatar" id="avatar-container">
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#browser_file").on("change", function () { //Upload pic on browse file
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('/Frontdesk/upload_profile_pic/') ?>",
                    data: formData,
                    contentType: false,
                    processData: false,
            ...
            $("#update-button").on("click", function (e) {
                ...
                setTimeout(function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "<?= base_url('/Frontdesk/update_profile/') ?>",
                        data: {
                            username: username,
                            email: email,
                            mobile: mobile,
