                    ...
                    <select name="selected_dr_appoint" id="selected_dr_appoint" class="select-item select_content">
                        ...
                        <?php  $newSlotsArr = [];  //for addressing notices  
                            ...
                            foreach ($doctors as $doc): //Doctor Drop-down - START
                                ...
                                foreach ($dr_slots as $slots): //Grouped Slots - START
                                    if ($doc->ref_id == $slots->doctor_id) {
                                        $newSlotsArr[$doc->ref_id][] = $slots;
                                    } 
                                endforeach; endif; //Grouped Slots - END ?>
    ...
    <div class="dr_container" id='slotGrid'>
        ...
        if(!empty($doctors)) {
            foreach($doctors as $doc) { ?>
                ...
                <!-- Draw Slots - START -->
                <?php //echo "<pre>"; print_r($newSlotsArr);die; 
                ...
                <form id="slotfrm<?php echo $doc->ref_id; ?>" class="brder_bottm" name="slotfrm" action="" method="post">
                    <div class="slot-grid mrgn_lft_rght">
                        ...
                        <?php foreach($newSlotsArr[$doc->ref_id] as $slots) { 
                            ...
                            if($slot_time < $current_time || $slots->dr_available == 0) { 
                                #Disble passed time and the booked slots ?> 
                            ...
                            else { #Enable future and the non-booked slots ?>
    ...
    <script>
        ...
        $(document).ready(function() {// To get the success message form the appointment page
            ...
            */
            ...
            //                             $('#dr_div_ajax').text(slotData[0].dr_name);
            ...
            */
            ...
            $("#yearList").on('click', '.select-item', function() {
                ...
                //var currentDateYYYYMMDD = selectedYear + '-' + ("0" + (months.indexOf(selectedMonth) + 1)).slice(-2) + '-' + ("0" + selectedDate).slice(-2);
                var selectedDate = selectedYear + '-' + ("0" + (months.indexOf(selectedMonth) + 1)).slice(-2) + '-' + ("0" + selectedDate).slice(-2);
                    ...
                    Object.values(availableSlots).forEach(function(doctor) {
                        ...
                        checkIfImageExists(imagePath, function(exists) {
                            ...
                            doctor.slots.forEach(function(slot) {
                                ...
                                //console.log(indiacurrentDateYYYYMMDD); // Output: "31/03/2025"
            ...
            $(document).on("click", ".pickslot_ajax", function(event) {
               ...
               // console.log("Selected doctor id " + selected_dr_id);
                ...
                if(typeof selected_dr_id === 'undefined' || selected_dr_id === null || typeof selectedDate === 'undefined' || selectedDate === null || typeof newpick_slt === 'undefined' || newpick_slt === null ||  typeof doc_name === 'undefined' || doc_name === null || typeof newpick_slt_id === 'undefined' || newpick_slt_id === null) { //Mandatory parameter check
                    ...
                    window.location.href = "<?= base_url('Frontdesk/pick_slots/') ?>?" + queryString;
                }
            }); 
            

           /* @params: Required parameter is booking_slot_arr with value s
            * elect "Slot", "Doctor ID", "Doctor Name" & "Date"
            ...
            */
            ...
            $(".pickslot").on("click", function() { //Pickup Slot
                ...
                //console.log("value is---> " + newpick_slt_id);
                //console.log(JSON.stringify($(this).data("slot_id"), null, 2));
                //$('#calendarDays .selected').text().trim();
                //if(typeof newpick_slt=='undefined' || typeof newpick_slt_id==''){
                if (typeof newpick_slt == 'undefined' || newpick_slt_id.length == 0) {
                    alert("Selected value is null, Please select Dr. slot");
                    return false;
                }
                else{
                    var new_booking_slot_arr = {
                    ...
                    //console.log(JSON.stringify(new_booking_slot_arr, null, 2));
                    //return false;
                    var queryString = $.param(new_booking_slot_arr);
                    window.location.href = "<?= base_url('Frontdesk/pick_slots/') ?>?" + queryString;
                }
        ...
        //     newSlotElem = slotElement;//For avoiding old assigned value of slotElement
        //     // console.log(JSON.stringify(newSlotElem, null, 2));
        //     // console.log(JSON.stringify(drid, null, 2));
        //     // console.log(JSON.stringify(slotid, null, 2));
        ...
        //     $('.slot').click(function() {
        //         if (slotElement) {
        //             slotElement.removeClass('selected'); //De-select slot
        //         }
        ...
        //     console.log("pick_slt2 val " + JSON.stringify(pick_slt, null, 2));
            
        //     if (typeof(pick_slt) !== 'undefined' && pick_slt !== null) { 
        //         var delimiter = / /; //Space is must here for Blank delemeter ie " "
        //         //Split the string at the match
        //         var split_pick_slt_arr = pick_slt.split(delimiter);
        //         if (typeof(split_pick_slt_arr[1]) !== 'undefined' && split_pick_slt_arr[1] !== null) {
        //             newpick_slt = split_pick_slt_arr[0];
        //             newpick_slt_id = split_pick_slt_arr[1];
        //         } 
        //         else { //console.log("ffffffffffffff");
        //             newpick_slt = '';
        //             newpick_slt_id = '';
        //             console.log("Picked slot ID is missing");
        //         }
        //     } 
        //     else { //console.log("llllllllllllll");
        //         newpick_slt = '';
        //         newpick_slt_id = '';
