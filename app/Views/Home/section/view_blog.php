                ...
                <div class="row">
                  ...
                  <div class="col-md-3 col-sm-4">
                    <aside class="sidebar">
                                ...
                                <div class="media">
                                  <div class="media-left">
                                    <a href="#" class="news-img">
                                      <img alt="img" src="<?= base_url('public/assets/home_image/images/choose-us-img3.jpg'); ?>" class="media-object">
                                      <!-- . $blog->blog_image  need to write inside to the image section to get the image that upload at the time of the add a blog -->
                                    </a>
                                  </div>
                      ...
                      <div class="sidebar-widget">
                        <h3>Text Widget</h3>
                        <p class="paratext">This is text widget of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly <a href="#">believable</a></p>
                      </div>
                      <!-- Start sidebar widget -->
                      <div class="sidebar-widget">
                        <h3>Archives</h3>
                  ...
                  <div class="col-md-9 col-sm-8">
                    <div class="blog-content">
                      ...
                      <?php if ($view_blog) :
                        count($view_blog);
                        //echo "<pre>"; print_r($view_blog);die;
                            ...
                            <div class="single-blog-right">
                              <div class="blog-img">
                                <figure class="blog-figure">
                                  <!-- <a href="#"><img alt="img" src="<//?= base_url('public/assets/home_image/images/choose-us-img3.jpg'); ?>"></a> -->
                                  <span class="image-effect"></span>
                                  <a class="tooltipped" data-position="top" data-tooltip="<?= $blogs->blog_image; ?>">
                                    <?php
                                    if (isset($blogs->blog_image) && !empty($blogs->blog_image)) {
                                      if (file_exists(FCPATH . 'uploads/frontend/blog_image/' . $blogs->blog_image)) { ?>
                                        <img src="<?= base_url() . 'public/uploads/frontend/blog_image/' . $blogs->blog_image; ?>" class="responsive-img patient_imgblog" id="profile_pic">
                        ...
                        <?php endforeach; ?>
                      <?php else : ?>
                        <h6 class="col_red">Not Any Posted here</h6>
                      <?php endif; ?>
                    </div>
                  </div>
  </section>
