...
button::after {
  content: "";
  /* Before it was showing a white dott after removing the bg white dott will be dissapper 03/07/2023 july changes done by kamlesh  */
  /* background: #fff; */
  position: absolute;
  z-index: -1;
...
.readmore_area a {
  ...
  text-transform: uppercase;
  border: 2px solid #14ffdf !important;
}
.readmore_area {
  float: left;
  margin-top: 40px;
...
/******** PATIENT DETAIL FORM (SEARCH BAR CSS START) ********/
.appoint_inner {
  margin-top: 50px;
}
.topdv {
...
/* line 156, ../../../app/sass/custom_style.scss */
.blue_lnk_hver:hover {
  color: #33CCFF !important;
  border: 1px solid #14ffdf;
}

/* line 161, ../../../app/sass/custom_style.scss */
.twiter_lnk_hver:hover {
  color: #33CCFF !important;
  border: 1px solid #14ffdf;
}

/* line 165, ../../../app/sass/custom_style.scss */
.whatsapp_lnk_hver:hover {
  color: #33CCFF !important;
  border: 1px solid #14ffdf;
}

/* line 169, ../../../app/sass/custom_style.scss */
.inst_lnk_hver:hover {
  color: #33CCFF !important;
  border: 1px solid #14ffdf;
}
...
/* line 173, ../../../app/sass/custom_style.scss */
.lnk_hver:hover {
  color: #fff !important;
}
...
@media (max-width: 767px) {
  ...
  .slider-text h2{
    text-shadow: -1px -3px 0 #09e3bd;
  }
  .slider-text p{
    font-size: 26px;
    text-shadow: -1px -2px 0 #09e3bd;
  }
}
.navbar-brand>i{
	margin-right: 8px;
...
.slider-text h2 {
  color: #3d93dd !important;
  font-size: 55px;
  line-height: 55px;
  text-shadow: -3px -3px 0 #09e3bd;
}
...
.service-icon .service-icon-effect {	
	...
	transition: -webkit-background 0.2s, color 0.2s;
}
...
/*@raaj: Used in custom_style.css as well */
...
.whychoose-slider .slick-prev::before {
  content: "\f104";
  font-family: FontAwesome;
  font-size: 25px;
  left: 1px;
...
.whychoose-slider .slick-next::before {
  content: "\f105";
  font-family: FontAwesome;
  font-size: 25px;
  left: 4px;
...
.slick-dots li {
  border: 2px solid #53ddca !important;
}
...
input[required="required"]:valid + .req_placeholder1 {
  display: none;
}

input[required="required"]:valid + .req_placeholder2 {
  display: none;
}

input[required="required"]:valid + .req_placeholder3 {
  display: none;
}
input[required="required"]:valid + .req_placeholder5 {
  display: none;
}
input[required="required"]:valid + .req_placeholder6 {
  display: none;
}
input[required="required"]:valid + .req_placeholder7 {
  display: none;
}
input[required="required"]:valid + .req_placeholder8 {
  display: none;
}
input[required="required"]:valid + .req_placeholder9 {
  display: none;
}
input[required="required"]:valid + .req_placeholder10 {
  display: none;
}
...
.req_placeholder1 span {
	color: red;
	right: 4px;
  position: relative
}
.req_placeholder2 span {
	color: red;
	right: 4px;
  position: relative
}
.req_placeholder3 span {
	color: red;
	right: 4px;
  position: relative
}
...
@media(max-width:1199px ){
  ...
  .doctors-nav figcaption p {font-size: 18px;padding: 0 12px;}
...
@media(max-width:991px ){	
  ...
  .doctors-nav .slick-prev {left: 0px;}
  .doctors-nav .slick-next {right: -5px;}
