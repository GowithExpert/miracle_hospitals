...
<body class="admin_login_back">
	...
	<div class="row" id="mrg_top">
		...
		<div class="col l4 m12 s12">
			...
			<!---card Section --->
			<?= form_open('Accountant_login/accountant_login'); ?>
			<div class="card">
				<!---Php Meassge Show --->
				<div>
					<?php
				...
				<div class="card-content brdr_rdius" id="login_id_with_image">
					...
					<h5 class="center-align log_pge_hedng">Accountant Login</h5>
					...
					<a href="<?= base_url('Accountant_login/forget_password'); ?>" class="forgot_pass_btn">Forget Password ?</a>

					<p class="new_user_btn">New User?<a href="<?= base_url('Accountant_login/index'); ?>" class="cret_acc_btn"> Create Account</a></p>

					<h6 class="h6_notes_doctor">Notes:</h6>
					<p class="login_para_1">Hospital Management Software Login Panel </p>
					<p class="login_para_2">Here ! Medical Accountant Login !</p>
