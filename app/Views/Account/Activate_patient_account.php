	...
	<div class="container">
		<div class="card" style="background: black;margin-top: 5%;">
			...
			<div class="card-content">
				<center>
					<a href="<?= base_url('Patients_login/login'); ?>" class="btn btn-waves-effect waves-light" style="background: #005197;text-transform: capitalize;font-weight: 500;border-radius: 5px;"><span class="fa  fa-key"></span>  Go to Login Account</a>
				</center>
			</div>
		</div>
	</div>
