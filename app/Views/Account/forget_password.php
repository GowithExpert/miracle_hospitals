				...
				<div class="card brdr_rdius forgt_card_cntnt">
					...
					<div class="card-content">
						<div class="input-container">
							<input type="text" name="email" maxlength="40" class="asterisk inpt_area margn_tp" id="input_box" value="<?= set_value('email'); ?>" placeholder="Enter Email Id">
						...
						<br>
						<center>
							<p class="bck_to_logn"><a class="flex" href="<?= base_url('Frontdesk_login/login_account'); ?>"><i class="fa fa-angle-left"></i> Back to Login</a></p>
						</center>
					</div>
				</div>
				<?= form_close(); ?>
