			...
			<div class="col l8 m8 s12">
				<div class="card" style="box-shadow: none;">
					...
					<div class="card-content mrgn_top">
						...
						<?= form_open('Medical_Accountantadd_patient_payment/' . $get_patient[0]->patients_id . '/' . $get_patient[0]->pid . '/' . $get_patient[0]->id  . '/' . $get_patient[0]->puid); ?>
						<div class="row">
							<div class="col l12 m12 s12">
								<h5 class="h5_align1"><span class="fa fa-rupee col_blu"></span> Room Charge</h5>
								<div class="input-container">
									<input type="number" name="room_charge" class="wp-form-control asterisk txt_rgt input-field room_charge" id="input_box" placeholder="Enter Room Charge" required data-validation="Please enter room charges">
						...
						<div class="row">
							<div class="col l12 m12 s12">
								...
								<div class="input-container">
									<input type="number" name="doc_fee" class="wp-form-control txt_rgt asterisk input-field doctor_fee" id="input_box" placeholder="Enter Doctor Fee" required data-validation="Please enter the valid doctor fees">
									<span class="asterisk-symbol">*</span>
									<span class="validation" style="color: red;"></span>
								</div>
								<?php if (isset($validation)) { ?>
						...
						<div class="row">
							<div class="col l12 m12 s12">
								...
								<div class="input-container">
									<input type="number" name="med_cost" class="wp-form-control asterisk txt_rgt input-field medicine_cost" id="input_box" placeholder="Enter Medicine Cost" required data-validation="Please enter the medical cost">
									<span class="asterisk-symbol">*</span>
									<span class="validation" style="color: red;"></span>
								</div>
								<?php if (isset($validation)) { ?>
						...
						<div class="row">
							<div class="col l12 m12 s12">
								...
								<input type="number" name="other_cost" class="wp-form-control txt_rgt input-field other_cost" id="input_box" placeholder="Other Cost" data-validation="Please enter the other cost">
								<?php if (isset($validation)) { ?>
						...
						<div class="row">
							<div class="col l12 m12 s12">
								...
								<input type="number" name="total" class="wp-form-control txt_rgt readonly_bg total-field" id="input_box" placeholder="Total Amount" readonly>
								<?php if (isset($validation)) { ?>
									<span style="color: red"><?= display_error($validation, 'total'); ?></span>
									<?= $validation->listErrors(); ?>
								<?php } ?>
							</div>
						</div>
