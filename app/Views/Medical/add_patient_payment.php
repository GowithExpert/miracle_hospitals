			...
			<div class="col l8 m8 s12">
				...
				<div class="card">
					...
					<div class="midsec mrgn_top">
						...
						<?= form_open('Medical_Accountant/add_patient_payment/' . $get_patient[0]->patients_id . '/' . $get_patient[0]->pid . '/' . $get_patient[0]->id  . '/' . $get_patient[0]->puid,array('name' => 'add_patient_payment','onsubmit' => 'return(validate());')); ?>
						<!-- new code -->
						<div class="row">
							<div class="col l3 m3 s12">
