...
<head>
	<title>Manage Sales Record</title>
...
<body>
	...
	<div class="card" style="box-shadow: none;margin-right: 15px;margin-left: 15px;">
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 5px;">
			<h5 style="font-weight: 500;margin-top: 5px; font-size: 20px;"><span class="fa fa-flask" style="color: #ff3d00"></span>  Manage Today's Sales Report <span class="right"><a href="#!" class="modal-trigger btn_hver" data-target="customize_sale_modal" style="font-size: 15px;font-weight: 500;">
		</div>
		<?php if ($sales) : ?>
			<div class="card-content" style="border-bottom: 1px solid silver;padding: 10px;">
				...
				<div class="modal" id="customize_sale_modal">
					<div class="modal-content" style="padding: 10px;border-bottom: 1px solid silver;">
						<h6 style="font-size: 20px;color: #333;font-weight: 500;"><span class="fa fa-filter"></span>  Customize Sales Report</h6>
					</div>
				...
				<table class="tbale">
					...
					?>
							<tr>
								...
								<td class="txt_break-at300" style="font-size: 14px;font-weight: 500;color: black;">(<?= date('D, M. d Y', strtotime($all_sale['order_date'])); ?>) Customers <br />
									<?php
								...
								<td class="txt_break-at300" style="text-align: right;">
						...
						<?php endforeach; ?>
					<?php else : ?>
						<h6 style="color: black;font-weight: 500">Sales Not Found</h6>
					<?php endif; ?>
				</table>
			<?php else : ?>
