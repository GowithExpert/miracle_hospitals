			...
			<div class="col l8 m8 s12">
				<div class="card">
					...
					<div class="card-content">
						...
						<?= form_open('Medical_Accountant/save_admission_fee/' . $apmt_patient[0]->patients_id . '/' . $apmt_patient[0]->pid . '/' . $apmt_patient[0]->id . '/' . $apmt_patient[0]->puid . '/' . $apmt_patient[0]->serial) ?>
						<div class="row">
							...
							<div class="col l8 m8 s11">
								<div class="input-container">
									<input type="number" name="admission_fee" id="admission_fee" class="asterisk other_charges input_box plcehldr_lft" placeholder="Enter Admission Fee" value=''>
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
								<div class="input-container">
									<input type="number" name="other_charges" class="asterisk over_error other_charges input_box plcehldr_lft" id="other_charges" placeholder="Enter Other charges" value=''>
									<span class="asterisk-symbol">*</span>
								</div>
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
								<div class="input-container">
									<input type="number" name="total_payable" class="asterisk over_error text_align readonly_bg input_box plcehldr_lft" id="total_payable" readonly placeholder="Total payable" value="">
									<span class="asterisk-symbol">*</span>
								</div>
