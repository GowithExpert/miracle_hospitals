			...
			<div class="col l8 m8 s12">
				<div class="card">
					<div class="card-content brder">
						<h6 class="ttle"><i class='fas fa-rupee-sign colr'></i> Add Fees</h6>
					</div>
					<div class="card-content">
						...
						<div class="row">
							...
							<?php if (is_array($apmt_patient)) { //echo "<pre>"; print_r($apmt_patient); die;
								if (isset($apmt_patient[0]->{'patient_phone'}) && isset($apmt_patient[0]->{'patient_phone'})) { ?>
									<h6 class="sty">Patient Name : <?= $apmt_patient[0]->{'patient_name'}; ?></h6>
									<h6 class="sty">Patient Mobile : <a class="btn_algin" href="tel:"><?= $apmt_patient[0]->{'patient_phone'}; ?></a></h6>
						  <?php } else { ?>
					...
					<div class="card-content">
						<?php //echo "<pre>"; print_r($apmt_patient); die; ?>
						<?= form_open('Medical_Accountant/save_fee/' . $apmt_patient[0]->patients_id . '/' . $apmt_patient[0]->pid . '/' . $apmt_patient[0]->id . '/' . $apmt_patient[0]->puid . '/' . $apmt_patient[0]->serial . '/' . $apmt_paymnt_payid) ?>
						<div class="row">
							...
							<div class="col l8 m8 s11">									
								<?php if(isset($appointment_fee)) { ?>
									<input type="number" name="appointment_fee" class="readonly_bg plcehldr_lft" id="appointment_fee" placeholder="Appointment Fee" readonly value="<?= $appointment_fee; ?>">
								<?php } else { ?>
								<input type="number" name="appointment_fee" class="readonly_bg plcehldr_lft" id="appointment_fee" placeholder="Appointment Fee" readonly value="<?= '0.00'; ?>">
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
								<div class="input-container">
									<input type="number" name="doctor_fee" class="asterisk over_error plcehldr_lft" id="doctor_fee" placeholder="Enter Doctor Fee" value="<?= $doctor_info[0]->doctor_fee; ?>">
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
							<div class="input-container">
								<input type="text" name="total_payable" class="asterisk over_error text_align readonly_bg plcehldr_lft" id="total_payable" placeholder="0.00" value="" readonly>
								<span class="asterisk-symbol">*</span>
							</div>
								<?php if (isset($validation)) { ?>
