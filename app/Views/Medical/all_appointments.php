				...
				<?php if ($all_appointments) : ?>
					...
					<div class="row">
						<div class="col l8 m8 s12">
							<?= form_open('Medical_Accountant/search_all_appointments'); ?>
							<ul id="search_doctor">
								<li>
						...
						<div class="col l4 m4 s12">
							...
							<ul class="dropdown-content" id="doctor_filter">
								...
								<li><a href="<?= base_url('Medical_Accountant/filter_appointment/new_appointment'); ?>" class="waves-effect" id="dotted_border">
										<span class="fa fa-users col_blu"></span> New Appointment </a></li>
								<li><a href="<?= base_url('Medical_Accountant/filter_appointment/old_appointment'); ?>" class="waves-effect">
							...
							<tr>
								...
								<td>
									...
									<?php if ($t_appointment['status'] == 0) :  ?>
										...
										<li><a href="<?= base_url('Medical_Accountant/change_all_appointments_status/' . $t_appointment['id'] . '/1' . '/' . $t_appointment['pid'] . '/' . $t_appointment['puid'] . '/' . $t_appointment['serial'] . '/' . $t_appointment['doctor_id']); ?>" id="dotted_border">
												<span class="fa fa-calendar"></span>  Appointment</a></li>
										
										<li><a href="<?= base_url('Medical_Accountant/change_all_appointments_status/' . $t_appointment['id'] . '/3' . '/' . $t_appointment['pid'] . '/' . $t_appointment['puid'] . '/' . $t_appointment['serial'] . '/' . $t_appointment['doctor_id']); ?>" id="dotted_border">
												<span class="fa fa-hourglass-o"></span> Waiting</a></li> 
										
										<li><a href="<?= base_url('Medical_Accountant/change_all_appointments_status/' . $t_appointment['id'] . '/5' . '/' . $t_appointment['pid'] . '/' . $t_appointment['puid'] . '/' . $t_appointment['serial'] . '/' . $t_appointment['doctor_id']); ?>" id="dotted_border">
												<span class="fa fa-exclamation-triangle"></span> Absent</a></li>
								
										<li><a href="<?= base_url('Medical_Accountant/change_all_appointments_status/' . $t_appointment['id'] . '/2' . '/' . $t_appointment['pid'] . '/' . $t_appointment['puid'] . '/' . $t_appointment['serial'] . '/' . $t_appointment['doctor_id']); ?>" 	id="dotted_border" class="delete-today-appointment-link" style="color:red;">
												<span class="fa fa-trash col_red"></span> Delete</a></li>

							
									<?php elseif ($t_appointment['status'] == 1) : ?>
										<!--0: Cancelled, 1: Appointment, 2: Deleted, 3: Awaited, 4: Attended, 5: Patient Not Reached, 6: View -->
										<li><a href="<?= base_url('Medical_Accountant/add_fee/' . $t_appointment['id'] . '/4' . '/' . $t_appointment['pid'] . '/' . $t_appointment['puid'] . '/' . $t_appointment['serial']) . '/' . $t_appointment['doctor_id']; ?>" id="dotted_border" target="_blank">
										...
										<li><a href="<?= base_url('Medical_Accountant/change_all_appointments_status/' . $t_appointment['id'] . '/0' . '/' . $t_appointment['pid'] . '/' . $t_appointment['puid'] . '/' . $t_appointment['serial'] . '/' . $t_appointment['doctor_id']); ?>" style="color:red;" id="dotted_border">
									...
									<?php elseif ($t_appointment['status'] == "2") : ?>
										...
										<li><a href="<?= base_url('Medical_Accountant/permanent_del_today_apmnt/' . $t_appointment['id'] . '/' . $t_appointment['pid'] . '/' . $t_appointment['puid'] . '/' . $t_appointment['serial'] . '/' . $t_appointment['doctor_id']); ?>" id="dotted_border" class="permanent-delete-today-appointment-link" style="color:red;">
