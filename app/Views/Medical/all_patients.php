	...
	<div class="equl_mrgn">
		...
		<?php
			...
			<div class="card-content" id="brdr_botm_silvr">
				<h5 class="font_weght"><span class="fa fa-wheelchair col_blu"></span>  All Patients</h5>
			</div>
			<div class="card-content" id="brdr_botm_silvr">
				<?php if ($patients) : ?>
					...
					<div class="row">
						...
						<div class="col l2 m2 s2">
							<span class="right">
								<div class="tooltip"><a href="<?= base_url('Medical_Accountant/add_patients') ?>"><i class="fa fa-plus-circle plus_icon_mgt"></i></a>
							...
							<tr>
								...
								<td class="txt_break-at300 txt_align">
									...
									elseif ($pat_rec['status'] == "Prescribed") :
										...
										//echo '<span class="span_gren_colr">' . $pat_rec['status'] . '</span>';
									?>
									<?php endif; ?>
								</td>
								...
								<td>
									...
									<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $pat_rec['id'] . '/' . $pat_rec['pid']; ?>">
										...
										<?php if ($pat_rec['status'] == "Admit") :  ?>
											<li><a href="<?= base_url('Medical_Accountant/print_slip/' . $pat_rec['id'] . '/' . $pat_rec['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>  Print Slip</a></li>
											<li><a href="<?= base_url('Medical_Accountant/add_patient_payment/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-rupee col_blu"></span>  Receive Payment</a></li>
											<li><a href="<?= base_url('Medical_Accountant/add_hospital_expenses/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-h-square col_blu"></span>  Add Hospital Expenses</a></li>
											<li><a href="<?= base_url('Medical_Accountant/show_patient_final_payments/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border"><span class="fa fa-money"></span>   Clear Final Payment</a></li>
											<!-- <li><a href="<//?= base_url('Medical_Accountant/delete_patients/'. $pat_rec['id'] . '/' . $pat_rec['pid']); ?>" id="dotted_border" class="delete-patient-link" target="" style="color: red"><span class="fa fa-trash col_red"></span>   Delete</a></li> -->
										...
										<?php elseif ($pat_rec['status'] == "Discharge Summary") : ?>
											...
											<li><a href="<?= base_url('Medical_Accountant/add_patient_payment/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/Discharge Processed'); ?>" id="dotted_border" style="color:red"><span class=" fa fa-wheelchair col_red"></span>   Discharge Processed</a></li>
											<li><a href="<?= base_url('Medical_Accountant/change_patients_status/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/Admit'); ?>" id="dotted_border"><span class="fa fa-eye col_blu"></span>  Re-Admit</a></li>
											<li><a href="<?= base_url('Medical_Accountant/delete_patients/'. $pat_rec['id'] . '/' . $pat_rec['pid']); ?>" id="dotted_border" class="delete-patient-link" target="" style="color: red"><span class="fa fa-trash col_red"></span>   Delete</a></li>
											<li><a href="<?= base_url('Medical_Accountant/print_slip/' . $pat_rec['id'] . '/' . $pat_rec['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>   Print Slip</a></li>
											<li><a href="<?= base_url('Medical_Accountant/change_patients_status/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/Prescribed'); ?>" id="dotted_border"><span class="fa fa-plus-square"></span>  Prescribed</a></li>
										...
										<?php elseif ($pat_rec['status'] == "Deleted") : ?>
											...
											<li><a href="<?= base_url('Medical_Accountant/add_patient_payment/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/Discharge Processed'); ?>" id="dotted_border" style="color:red"><span class=" fa fa-wheelchair col_red"></span>   Discharge Processed</a></li>
											<li><a href="<?= base_url('Medical_Accountant/print_slip/' . $pat_rec['id'] . '/' . $pat_rec['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>   Print Slip</a></li>
											<li><a href="<?= base_url('Medical_Accountant/permanent_del_patients/' . $pat_rec['id'] . '/' . $pat_rec['pid']); ?>" id="dotted_border" class="permanent-delete-patient-link" style="color: red;"><span class="fa fa-trash col_red"></span>  Permanent Delete</a></li>
											
										<?php elseif ($pat_rec['status'] == "Prescribed") : ?>

											<li><a href="<?= base_url('Medical_Accountant/show_patient_final_payments/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border"><span class=" fa fa-money "></span>   Clear Final Payment</a></li>
											<li><a href="<?= base_url('Medical_Accountant/change_patients_status/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/Admit'); ?>" id="dotted_border"><span class="fa fa-eye col_blu"></span> Admit Patient</a></li>
											<li><a href="<?= base_url('Medical_Accountant/print_slip/' . $pat_rec['id'] . '/' . $pat_rec['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>   Print Slip</a></li>
											<li><a href="<?= base_url('Medical_Accountant/add_patient_payment/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>  Receive Payment</a></li>
											<li><a href="<?= base_url('Medical_Accountant/add_hospital_expenses/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-h-square col_blu"></span>  Add Hospital Expenses</a></li>

										<?php elseif ($pat_rec['status'] == "Attended") : ?>

											<!-- <li><a href="<//?= base_url('Medical_Accountant/admit_patient/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid'] . '/' . $pat_rec['serial'] . '/' . $pat_rec['doctor_id']); ?>" id="dotted_border" target="_blank"><span class="fas fa-procedures col_blu"></span> Add Admission Fee</a></li> -->
											<li><a href="<?= base_url('Medical_Accountant/show_patient_final_payments/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border"><span class=" fa fa-money "></span>   Clear Final Payment</a></li>
											<li><a href="<?= base_url('Medical_Accountant/print_slip/' . $pat_rec['id'] . '/' . $pat_rec['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>   Print Slip</a></li>
											<li><a href="<?= base_url('Medical_Accountant/add_patient_payment/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>  Receive Payment</a></li>
											<li><a href="<?= base_url('Medical_Accountant/add_hospital_expenses/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-h-square col_blu"></span>  Add Hospital Expenses</a></li>
										...
										<?php elseif ($pat_rec['status'] == 1) : ?>
											<!-- <li><a href="</?= base_url('Medical_Accountant/change_patients_status/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/Discharged'); ?>" id="dotted_border" style="color:red"><span class="fa  fa-eye-slash col_red"></span> Discharge</a></li> -->
											<!-- <li><a href="<//?= base_url('Medical_Accountant/admit_patient/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid'] . '/' . $pat_rec['serial'] . '/' . $pat_rec['doctor_id']); ?>" id="dotted_border" target="_blank"><span class="fas fa-procedures col_blu"></span> Re-Admit Patient</a></li> -->
											<li><a href="<?= base_url('Medical_Accountant/print_slip/' . $pat_rec['id'] . '/' . $pat_rec['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>  Print Slip</a></li>
											<li><a href="<?= base_url('Medical_Accountant/add_patient_payment/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-rupee col_blu"></span> Receive Payment</a></li>
											<li><a href="<?= base_url('Medical_Accountant/add_hospital_expenses/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-h-square col_blu"></span> Add Hospital Expenses</a></li>
											<li><a href="<?= base_url('Medical_Accountant/show_patient_final_payments/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border"><span class=" fa fa-money "></span>   Clear Final Payment</a></li>

										<?php elseif ($pat_rec['status'] == 2) : ?>
											<!-- <li><a href="<//?= base_url('Medical_Accountant/admit_patient/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid'] . '/' . $pat_rec['serial'] . '/' . $pat_rec['doctor_id']); ?>" id="dotted_border" target="_blank"><span class="fas fa-procedures col_blu"></span> Admit Patient</a></li> -->
											<li><a href="<?= base_url('Medical_Accountant/print_slip/' . $pat_rec['id'] . '/' . $pat_rec['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>  Print Slip</a></li>
											<li><a href="<?= base_url('Medical_Accountant/add_patient_payment/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-rupee col_blu"></span> Receive Payment</a></li>
											<li><a href="<?= base_url('Medical_Accountant/add_hospital_expenses/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-h-square col_blu"></span> Add Hospital Expenses</a></li>
											<li><a href="<?= base_url('Medical_Accountant/show_patient_final_payments/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" id="dotted_border"><span class=" fa fa-money "></span>   Clear Final Payment</a></li>
										...
										<?php else : ?>
											...
											<li><a href="<?= base_url('Medical_Accountant/change_patients_status/' . $pat_rec['id'] . '/' . $pat_rec['pid'] . '/Admit'); ?>" id="dotted_border"><span class="fa fa-eye col_blu"></span>  Admit</a></li>
										<?php endif; ?>
