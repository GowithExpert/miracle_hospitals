		...
		<div class="row">
			...
			<div class="col l8 m8 s12">
				...
				<div class="card">
					...
					<div class="card-content">
						...
						<div class="row">
						  ...
						  <?php } else { ?>
							...
							<h6 class="sty">Admit Date : <?= isset($patients[0]->created_at) ? date('d M, Y', strtotime($patients[0]->created_at)) : 'N/A'; ?></h6>
							<h6 class="sty">Release Date : <?= date('d M, Y'); ?></h6>
							<h6 class="sty">Days Spent :	
								<?php
								$admint_day = isset($patients[0]->created_at) ? $patients[0]->created_at : null;
								$today = date("Y-m-d");
					...
					<div class="card-content">
					<?php if (is_array($patients) && isset($patients[0])):?>
							<?= form_open('Medical_Accountant/clear_final_dues/' . $patients[0]->id .'/'. $patients[0]->pid  .'/'. $patients[0]->apmt_id .'/'. $patients[0]->puid .'/'. $patients[0]->status); ?>
						<?php endif; ?>
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
							<div class="input-container">
								<input type="text" name="dues_amount" class="asterisk over_error text_align readonly_bg plcehldr_lft" id="dues_amount" placeholder="0.00" value="<?= $total_pay_amt - $total_expnc_amt['total_expnc_amt']; ?>>" readonly>
								<span class="asterisk-symbol">*</span>
							</div>
								<?php if (isset($validation)) { ?>
