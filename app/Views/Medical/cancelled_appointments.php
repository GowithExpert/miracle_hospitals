				...
				<?php if ($cancelled_apmt) : ?>
					...
					<div class="row">
						...
						<div class="col l8 m8 s12">
							<?= form_open('Medical_Accountant/search_canceled_appointments'); ?>
							<ul id="search_doctor">
								<li>
						...
						<div class="col l4 m4 s12">
							...
							<ul class="dropdown-content" id="doctor_filter">
								<li><a href="<?= base_url('Medical_Accountant/filter_del_appointments/new_patient'); ?>" class="waves-effect" id="dotted_border">
										<span class="fa fa-trophy col_blu"></span> New Patients </a></li>
								<li><a href="<?= base_url('Medical_Accountant/filter_del_appointments/old_patient'); ?>" class="waves-effect">
			...
			<div class="scroll-container card-content">
				<table class="table">
					<tr class="backgrnd_colr_gray">
						...
						<th class="txt_align">Appointment Date</th>
						<th class="txt_align">Appointment Time</th>
					...
					<?php if ($cancelled_apmt) :
						...
						foreach ($cancelled_apmt as $t_patient) : ?>
							...
							<tbody>
								<tr>
									<td class="text-container_mange_patient txt_break-at100">
										<?= $t_patient['serial']; ?>
									</td>
									<td class="text-container_mange_patient txt_break-at300 txt_align">
									...
									<td class="text-container_mange_patient txt_break-at300 txt_align col_ornge">
										<span class="break-word">
									...
									<td>
										<h6 class="txt_break-at300 txt_align">
											<span class="txt_align col_gren"> <?= date('D, M d Y', strtotime($t_patient['booking_date'])); ?></span>
										</h6>
									</td>
									<td>
										<h6 class="text-container_mange_patient txt_break-at300 txt_align">
									...
									<td>
										...
										<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $t_patient['id']; ?>">
											...
											<?php if ($t_patient['status'] == 0) :  ?>
												<li><a href="<?= base_url('Medical_Accountant/change_cancelled_appointments_status/' . $t_patient['id'] . '/1' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border">
												...
												<li><a href="<?= base_url('Medical_Accountant/change_cancelled_appointments_status/' . $t_patient['id'] . '/3' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border">
														<span class="fa fa-hourglass-o"></span> Waiting</a>
												</li><!--0: Cancelled, 1: Appointment, 2: Deleted, 3: Awaited, 4: Attended, 5: Patient Not Reached, 6: View -->
												<li><a href="<?= base_url('Medical_Accountant/change_cancelled_appointments_status/' . $t_patient['id'] . '/4' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border">
														<span class=" fa  fa-check "></span> Attend</a>
												</li><!--0: Cancelled, 1: Appointment, 2: Deleted, 3: Awaited, 4: Attended, 5: Patient Not Reached, 6: View -->
												<li><a href="<?= base_url('Medical_Accountant/change_cancelled_appointments_status/' . $t_patient['id'] . '/5' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border">
														<span class="fa fa-exclamation-triangle"></span> Absent</a>
												</li><!--0: Cancelled, 1: Appointment, 2: Deleted, 3: Awaited, 4: Attended, 5: Patient Not Reached, 6: View -->
												
											<?php elseif ($t_patient['status'] == 1) : ?>
												<li><a href="<?= base_url('Medical_Accountant/change_cancelled_appointments_status/' . $t_patient['id'] . '/0' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" style="color:red;" id="dotted_border">
														<span class="fa fa-ban col_red"></span> Cancel</a>
												</li><!--0: Cancelled, 1: Appointment, 2: Deleted, 3: Awaited, 4: Attended, 5: Patient Not Reached, 6: View -->
												<li><a href="<?= base_url('Medical_Accountant/change_cancelled_appointments_status/' . $t_patient['id'] . '/2' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" style="color:red;" id="dotted_border">
											...
											<?php else : ?>
												<li><a href="<?= base_url('Medical_Accountant/change_cancelled_appointments_status/' . $t_patient['id'] . '/Appointment'); ?>" id="dotted_border">
