		...
		<div>
				...
				<?php if ($today_apmnt) : ?>
					...
					<div class="row">
						<div class="col l9 m9 s12">
							<?= form_open('Medical_Accountant/search_today_appointments'); ?>
							<ul id="search_doctor">
								<li>
						...
						<!-- <div class="col l1 m1 s1">
								...
								$today_dis_patient = count($today_apmnt);
							?>
								<h6 style="color: red;margin-top: 25px;"><span class="fa fa-eye"></span> <//?= $today_dis_patient; ?></h6>
							<//?php endif; ?>
						</div> -->
						<div class="col l3 m3 s12">
							...
							<ul class="dropdown-content" id="doctor_filter">
								<li><a href="<?= base_url('Medical_Accountant/filter_today_appointment/new_patient'); ?>" class="waves-effect" id="dotted_border">
										<span class="fa fa-trophy col_blu"></span> New Patients </a></li>
								<li><a href="<?= base_url('Medical_Accountant/filter_today_appointment/old_patient'); ?>" class="waves-effect">
			...
			<div class="scroll-container card-content">
				<table class="table">
					...
					</ /?php if($today_apmnt): count($today_apmnt); <?php if (isset($today_apmnt) && (is_array($today_apmnt) || is_object($today_apmnt))) :
																						if (count($today_apmnt) == 0) { ?> <h6 class="col_red">No record found</h6>
				<?php }
							...
							<td>
								...
								<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $t_patient['id']; ?>">
									...
									<?php if ($t_patient['status'] == 0) :  ?>
										...
										<li><a href="<?= base_url('Medical_Accountant/change_today_appointments_status/' . $t_patient['id'] . '/1' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial'] . '/' . $t_patient['serial']); ?>" id="dotted_border">
												<span class="fa fa-calendar col_ornge"></span>  Appointment</a></li>
										
										<li><a href="<?= base_url('Medical_Accountant/change_today_appointments_status/' . $t_patient['id'] . '/3' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border">
												<span class="fa fa-hourglass-o"></span> Waiting</a></li> 
										
										<li><a href="<?= base_url('Medical_Accountant/change_today_appointments_status/' . $t_patient['id'] . '/5' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border">
												<span class="fa fa-exclamation-triangle"></span> Absent</a></li>
								
										<li><a href="<?= base_url('Medical_Accountant/change_today_appointments_status/' . $t_patient['id'] . '/2' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" 	id="dotted_border" class="delete-today-appointment-link" style="color:red;">
												<span class="fa fa-trash col_red"></span> Delete</a></li>

							
									<?php elseif ($t_patient['status'] == 1) : ?>
										<!--0: Cancelled, 1: Appointment, 2: Deleted, 3: Awaited, 4: Attended, 5: Patient Not Reached, 6: View -->
										<li><a href="<?= base_url('Medical_Accountant/add_fee/' . $t_patient['id'] . '/4' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']) . '/' . $t_patient['doctor_id']; ?>" id="dotted_border" target="_blank">
													<span class=" fa fa-check "></span> Add Doctor Fee</a></li>
										...
										<li><a href="<?= base_url('Medical_Accountant/change_today_appointments_status/' . $t_patient['id'] . '/0' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" style="color:red;" id="dotted_border">
									...
									<?php elseif ($t_patient['status'] == "2") : ?>
										...
										<li><a href="<?= base_url('Medical_Accountant/change_today_appointments_status/' . $t_patient['id'] . '/1' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border">
											<span class="fa fa-calendar"></span> Appointment</a></li>
										...
										<li><a href="<?= base_url('Medical_Accountant/permanent_del_today_apmnt/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border" class="permanent-delete-today-appointment-link" style="color:red;">
									...
									<?php else : ?>
										<li><a href="<?= base_url('Medical_Accountant/change_today_appointments_status/' . $t_patient['id'] . '/Appointment'); ?>" id="dotted_border">
												<span class="fa fa-calendar col_blu"></span> Appointment</a>
