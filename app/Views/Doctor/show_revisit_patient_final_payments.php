				...
				<div class="card">
					...
					<div class="card-content">
						...
						<div class="row">
							...
							<?php if (is_array($revisit_patient)) {
								if (isset($revisit_patient[0]->{'patient_phone'}) && isset($revisit_patient[0]->{'patient_phone'})) { ?>
									<h6 class="sty">Patient Name : <?= $revisit_patient[0]->{'patient_name'}; ?></h6>
									<h6 class="sty">Patient Mobile : <a class="btn_algin" href="tel:"><?= $revisit_patient[0]->{'patient_phone'}; ?></a></h6>
									<h6 class="sty">Puid : <?= $revisit_patient[0]->{'puid'}; ?></h6>
						  <?php } else { ?>
							...
							<div class="col l3 m3 s6">
								<h6 class="sty">Admit Date : <?= date('d M, Y', strtotime($revisit_patient[0]->created_at)); ?></h6>
					...
					<div class="card-content">
						<h5 class="h5_heding">Disease and Symptoms : <span class="h5_inside"><?= $revisit_patient[0]->disease_symptoms	; ?></span></h5>
					</div>
					<div class="card-content">
						<?= form_open('Doctor/clear_revisit_final_dues/' . $revisit_patient[0]->id .'/'. $revisit_patient[0]->pid .'/'. $revisit_patient[0]->apmt_id .'/'. $revisit_patient[0]->puid . '/' .$revisit_patient[0]->status); ?>
						<!-- Start-Custom -->
						<div class="row">
							...
							<div class="col l8 m8 s11">									
								...
								$total_expenses_value = $total_expnc_amt;
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
								...
								<div class="input-container">
									<input type="number" name="total_paid_amount" class="asterisk over_error readonly_bg plcehldr_lft" id="total_paid_amount" placeholder="Enter Total Patient Paid Amount" value="<?= $total_payable === 0 ? '0.00' : $patient_paid_amount; ?>" readonly>
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
							<div class="input-container">
								<input type="text" name="dues_amount" class="asterisk over_error inpt_pad readonly_bg plcehldr_lft" id="dues_amount" placeholder="0.00" value="<?= $total_pay_amt - $total_expnc_amt; ?>" readonly>
								<span class="asterisk-symbol">*</span>
							</div>
								<?php if (isset($validation)) { ?>
