...
<body class="admin_login_back">
	<!----Body Section Start --->
	<!-- DEBUG-VIEW START 8 APPPATH/Views/Doctor/index.php -->
	<!---Login Form --->
	<div class="row" id="mrg_top">
		...
		<div class="col l4 m12 s12">
			...
			<div class="card brdr_rdius">
				...
				<!---Php Meassge Show --->
				<?= form_open('Doctor_login/doctor_login', ['method' => 'post']) ?>
			
				<div class="card-content brdr_rdius" id="login_id_with_image">
					<h4 class="center-align h4_mrhn"><span class="fa fa-user-md fa_icon"></span></h4>
					<h5 class="center-align log_pge_hedng">Doctor Login</h5>
				...
				<div class="input-container">
					...
					<div class="password-container">
						<div class="image">
							<input type="password" name="password" class="passwordInput inpt_area" id="password" minlength="6" maxlength="20" placeholder="Password" value="<?= set_value('password'); ?>">
					...
					<a href="<?= base_url('Doctor_login/forget_password'); ?>" class="forgot_pass_btn">Forget Password ?</a>

					<p class="new_user_btn">New User?<a href="<?= base_url('Doctor_login/index'); ?>" class="cret_acc_btn"> Create Account</a></p>

					<h6 class="h6_notes_doctor">Notes:</h6>
					<p class="login_para_1">Hospital Management Software Login Panel </p>
					<p class="login_para_2">Here ! Doctor Login !</p>
				<?= form_close(); ?>
				</div>
			</div>
	...
	<script>
		$(document).ready(function() {
			$("#btn_sign_in").click(function(e) {
				...
				if (!valid) {
					console.log("value of valid variable is " + valid);
					e.preventDefault();
				}
			});
			setTimeout(function () {
