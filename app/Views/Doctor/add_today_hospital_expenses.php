...
<body>
  ...
  <div class="container-fluid">
    ...
    <div id="ajx_sucess_msg"></div>
      ...
      <?= form_open_multipart('Doctor/add_today_hospital_expenses'); ?>
        <div class="container">
          <form id="productForm">
            <div class="row row_mrgn_tp">
              ...
              <div class="col-lg-2 col-md-2 col-sm-12">
                ...
                <div class="input-container">
                  <input type="text" class="input_area asterisk medical_name plcehldr_algn_lft higt" name="medical_item_name" placeholder="Medical Item Name" id="medical_item_name" required>
                  <span class="asterisk-symbol">*</span>
                  <div id="medical_item_name_error" class="validation_error_msg"></div>
                </div>
              </div>
             
              <div class="col-lg-1 col-md-1 col-sm-12">
                <label class="fnt_size_expen" for="productCode">Item Code</label>
                <input type="text" class="input_area item_code plcehldr_algn_lft higt" name="item_code" id="item_code" placeholder="Item Code" required>
                <div id="item_code_error" class="validation_error_msg"></div>
              </div>
              
              <div class="col-lg-1 col-md-1 col-sm-12">
                <label class="fnt_size_expen" for="unit_price">Unit Price</label>
                <div class="input-container">
                  <input type="text" class="input_area txt_rgt asterisk unit_price plcehldr_algn_lft higt" value="0.00" name="unit_price" id="unit_price" placeholder="Unit Price" required>
                  <span class="asterisk-symbol">*</span>
                  <div id="price_error" class="validation_error_msg"></div>
                </div>
              </div>
              ...
              <div class="col-lg-1 col-md-1 col-sm-12">
                ...
                <div class="input-container">
                  <input type="text" class="input_area txt_rgt asterisk quantity plcehldr_algn_lft higt" name="quantity" id="quantity" value="1" placeholder="Quantity" required>
                  <span class="asterisk-symbol">*</span>
              ...
              <div class="col-lg-1 col-md-1 col-sm-12">
                ...
                <div class="input-container">
                  <input type="text" class="input_area txt_rgt asterisk tax plcehldr_algn_lft higt" name="tax" id="tax" value="0" placeholder="Tax(%)" oninput="calculateTotal()">
                  <span class="asterisk-symbol">*</span>
                  <div id="tax_error" class="validation_error_msg"></div>
                </div>
              </div>
              ...
              <div class="col-lg-1 col-md-1 col-sm-12">
                ...
                <div class="input-container">
                  <input type="text" class="input_area txt_rgt asterisk discount plcehldr_algn_lft higt" value="0" name="discount" id="discount" placeholder="Discount(%)" oninput="calculateTotal()">
                  <span class="asterisk-symbol">*</span>
                  <div id="discount_error" class="validation_error_msg"></div>
                </div>
              </div>
              <div class="col-lg-1 col-md-1 col-sm-12">
                <label class="fnt_size_expen" for="date">Date</label>
                <div class="input-container">
                  <input type="date" class="input_area asterisk date_inpt higt" name="date" id="date" placeholder="Date" required>
                  <span class="asterisk-symbol">*</span>
                  <div id="date_error" class="validation_error_msg"></div>
                </div>
              </div>
              
              <div class="col-lg-1 col-md-1 col-sm-12">
                <label class="fnt_size_expen" for="taxCalculation">Tax</label>
                <input type="text" class="input_area readonly_bg txt_rgt plcehldr_algn_lft higt" value="0.00" placeholder="Tax Amount" name="taxCalculation" id="taxCalculation" readonly>
              </div>
              <div class="col-lg-1 col-md-1 col-sm-12">
                <label class="fnt_size_expen" for="discountCalculation">Discount</label>
                <input type="text" class="input_area readonly_bg txt_rgt plcehldr_algn_lft higt" value="0.00" placeholder="Discount Amount" name="discountCalculation" id="discountCalculation" readonly>
              </div>
              
              <div class="col-lg-2 col-md-2 col-sm-12">
                <label class="fnt_size_expen" for="totalPrice">Total Price</label>
                <input type="text" class="input_area readonly_bg txt_rgt plcehldr_algn_lft higt" value="0.00" name="totalPrice" id="totalPrice" placeholder="Total Price" readonly>
              </div>
            </div>
            <!-- ... Your existing form ... -->
            <div class="row row_mrgn_tp">
            ...
            <script>
              $(document).ready(function() {
                ...
                function saveToTable() { 
                  ...
                  $.ajax({
                    type: 'POST',
                    url: "<?= base_url('/Doctor/save_today_hospital_expenses') ?>",
                    data: {
