  ...
  <div class="container-fluid">
    ...
    <div id="ajx_sucess_msg"></div>
      ...
      <div class="card-content" id="brdr_botm_silvr">
        ...
        <?= form_open_multipart('Doctor/add_revisit_hospital_expenses'); ?>
        <div class="container">
          <form id="productForm">
            ...
            <script>
              $(document).ready(function() {
                ...
                function saveToTable() { 
                  ...
                  $.ajax({
                    type: 'POST',
                    url: "<?= base_url('/Doctor/save_revisit_hospital_expenses') ?>",
                    data: {
                      ...
                      if (response.status) {//status: true - Redirect to another page with success message
                       // console.log(response.status);
                         $('#ajx_sucess_msg').html(response.message).show() 
                           .addClass('div_pad col_wite cutom_messge_styl bckgrnd_gren');
                           newRow = `
                            <tr>
