...
<body class="pres_bdy_back">
    ...
    <div id="multi-step-form-container">
        ...
        <div class="container topcontainer">
            ...
            <?= form_open_multipart('Doctor/upload_today_pat_prescription', array('id' => 'prescription_form', 'name' => 'prescription_form')) ?>
            <!-- Step 1 Content -->
            <section id="step-1" class="form-step presc-dummy mrgn_lft_rght">
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="mt-3">
                            <textarea class="placehldr" id="prescription" placeholder="Enter Prescription" name="prescription"></textarea>
                        </div>
                    </div>
                </div>
                <div class="mt-3">
            ...
            <section id="step-2" class="form-step d-none presc-dummy mrgn_lft_rght">
                <div id="custom_popup" class="disp_none">
                    <div class="popup_message"></div>
            
                    <!-- Add any other styling or buttons you need for your custom popup -->
                </div>
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="row">
                                    <div class="col-lg-1 col-md-1 col-sm-1 mrg_rgt">
                                        <input type="checkbox" name="report[]" <?php if (in_array('Blood Report', $report)) { echo 'checked disabled';  } ?> id="checkbox1" value="Blood Report"></div>
                                            <div class="col-lg-5 col-md-5 col-sm-5"> <span>Blood Report</span> </div>
                ...
                <div id="reportSection">
                    ...
                    <div class="row lft_rgt">
                        ...
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <input type="file" class="file-input" id="fileInput7" accept=".png, .PNG, .jpg, .JPG, .jpeg, .JPEG, .svg, .gif">
                        </div>
                        <div class="col-lg-3 col-md-3 col-sm-3">
            ...
            <section id="step-3" class="form-step presc-dummy d-none mrgn_lft_rght">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="mt-3 mt4">
                            <textarea class="placehldr" id="advice" placeholder="Enter Advise For Patient" name="advice"></textarea>
                        </div>
                    </div>
                </div>
                <!-- Step 3 input fields -->
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="mt-3">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <select required id="selctarea" name="selctarea">
                                        <option class="placeholder" selected disabled value="">Select User</option>
                                        <!-- <option>Admin</option> -->
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <textarea class="placehldr" id="message" placeholder="Enter Message For Patient" name="message"></textarea>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        $(document).ready(function() {
            ...
            $('#goto_step2_btn').click(function(event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?= base_url('/Doctor/upload_today_pat_prescription/') ?>",
                    data: {
                        doctor_name: doctor_name,
                        doctor_id: "<?php echo $res->doctor_id; ?>",
                        ...
                        patient_mobile:"<?php echo $res->patient_phone; ?>",
                    ...
                    success: function(response) {
                        ...
                        prescription_id = jsonResponse.data.prescription_id;
            ...
            //     var precribed_id = 'precribe_id';

            //     formData.append(browse_rpt_id, file);
            //     formData.append(precribe_id, prescription_id);

            //     $.ajax({
            //         type: "POST",
            //         url: "<//?= base_url('/Doctor/upload_prescription_report/' . $res->id); ?>/" + id + '/' + browse_rpt_id + '/' + prescription_id,
            //         data: formData,
            //         contentType: false,
            //         processData: false,
            //         success: function(response) {
            //             var jsonResponse = $.parseJSON(response);
            //             showCustomPopup('Success', response);
            //         },
            ...
            $(".file-input").change(function() {
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('/Doctor/upload_today_pat_prescription_report/' . $res->id); ?>/" + id + '/' + browse_rpt_id + '/' + prescription_id,
                    data: formData,
                    contentType: false,
                    processData: false,
                    success: function(response) {
                        ...
                        // Check if the showCustomPopup function exists before calling it
                        if (typeof showCustomPopup === 'function') {
                            try {
                                jsonResponse = $.parseJSON(response);
                                showCustomPopup('Success', jsonResponse.message, true);
            ...
            $('#goto_step4_btn').click(function(event) {
                ...
                if ($.trim(advice) != '') {
                    $.ajax({
                        type: 'POST',
                        url: "<?= base_url('/Doctor/save_today_pat_advice') ?>",
                        data: data,
                        dataType: 'text', // for 'string'
            ...
            $('#save').click(function(event) {
              ...
              var slct_refr_usr = $('#selctarea').find('option:selected').text();
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?= base_url('/Doctor/save_today_pat_message/') ?>",
                    data:{
                    ...
                    success: function(response) {
                        try {
                            ...
                            if (jsonResponse.message) {
                                ...
                                window.location.href = "<?= base_url('/Doctor/today_patients')?>?sucesMsg=" + encodedMessage;
                            } else {
        ...
        $("#goto_step3_btn").on("click", function() {
            ...
            if (checked.length != 0) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?= base_url('/Doctor/add_today_pat_prescription_report/' . $res->id); ?>",
                    data: dataArr,
                    dataType: 'text', //for 'string'
                    success: function(response) { // Handle the success response
                        var jsonResponse = $.parseJSON(response);
