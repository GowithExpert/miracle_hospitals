<!-- 
Copyright © 2023-2024 Neoark Software Pvt Ltd. today rights reserved.
	...
	<div class="equl_mrgn">
		...
		<div>
			...
			<div class="card-content" id="brdr_botm_silvr">
				<h5 class="font_weght"><span class="fa fa-wheelchair col_blu"></span>  Today Patients </h5>
			</div>
			<div class="card-content" id="brdr_botm_silvr">
				<?php if ($today_patients) : ?>
					<!--Search Bar & Filter Bar Section Start -->
					<div class="row">
						<div class="col l8 m8 s12">
							<?= form_open('Doctor/search_today_patient'); ?>
							<ul id="search_doctor">
								<li>
						...
						<div class="col l4 m4 s12">
							...
							<ul class="dropdown-content" id="doctor_filter">
								<li><a href="<?= base_url('Doctor/filter_today_patients/new_patient'); ?>" class="waves-effect" id="dotted_border">
										<span class="fa fa-trophy col_blu"></span>  New Patients </a></li>
								<li><a href="<?= base_url('Doctor/filter_today_patients/old_patient'); ?>" class="waves-effect">
			...
			<div class="scroll-container card-content">
				<table class="table">
					...
					<?php if(is_array($today_patients) || is_object($today_patients)) :
						count($today_patients);
						foreach ($today_patients as $t_patient) : ?>
							...
							<tbody>
								<tr>
									...
									<td class="txt_break-at300 txt_align">
										...
										elseif ($t_patient['status'] == 1) ://1: `Dues Cleared` Admitted, 2: `Dues Cleared` Non-Admit Patient
											echo '<span class="col_red">Dues Cleared</span>';
										elseif ($t_patient['status'] == 2) ://1: `Dues Cleared` Admitted, 2: `Dues Cleared` Non-Admit Patient
											echo '<span class="col_red">Dues Cleared</span>';
									...
									<td>
										...
										<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $t_patient['id']; ?>" id="dotted_border">
											...
											<?php if ($t_patient['status'] == "Admit") :  ?>
												<li><a href="<?= base_url('Doctor/add_today_patient_payment/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['apmt_id'] . '/' . $t_patient['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-rupee col_blu"></span>  Receive Payment</a></li>
												<li><a href="<?= base_url('Doctor/add_today_hospital_expenses/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['apmt_id'] . '/' . $t_patient['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-h-square col_blu"></span>  Add Hospital Expenses</a></li>
												...
												<li><a href="<?= base_url('Doctor/show_today_pat_final_pay/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['apmt_id'] . '/' . $t_patient['puid']); ?>" target="_blank" id="dotted_border"><span class=" fa fa-money "></span>   Clear Final Payment</a></li>
												<li><a href="<?= base_url('Doctor/add_today_pat_prescription/' . $t_patient['id']); ?>" id="dotted_border"><span class="fa fa-plus-square col_gren"></span>  Add Prescription</a></li>
												...
												<li><a href="<?= base_url('Doctor/edit_today_patients/' . $t_patient['id']); ?>" id="dotted_border"> <span class="fa fa-edit col_blu"></span>   Edit</a></li>
												<!-- <li><a href="javascript:void(0);" onclick="showDeleteConfirmationModal(<//?= $t_patient['id']; ?>);" id="dotted_border" target="" style="color: red"><span class="fa fa-trash col_blu"></span>   Delete</a></li>	 -->
												
											
											<?php elseif ($t_patient['status'] == "Payment Clear") : ?>
												<li><a href="<?= base_url('Doctor/change_today_patients_status/' . $t_patient['id'] . '/Admit'); ?>" styele="color:red;" id="dotted_border"><span class="fas fa-procedures col_blu"></span>  Re-Admit</a></li>
												...
												<li><a href="<?= base_url('Doctor/change_today_patients_status/' . $t_patient['id'] . '/Discharged'); ?>" id="dotted_border" style="color:red"><span class="fa fa-eye-slash col_red"></span>  Discharge</a></li>
											...
											<?php elseif ($t_patient['status'] == "Attended") : ?>
												<li><a href="<?= base_url('Doctor/get_dept_tday_for_admission/'. $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['apmt_id'] . '/' . $t_patient['doctor_id']); ?>" id="dotted_border"><span class="fas fa-procedures col_blu"></span> Admission Process</a></li>
												<li><a href="<?= base_url('Doctor/add_today_pat_prescription/' . $t_patient['id']); ?>" id="dotted_border"><span class="fa fa-plus-square col_gren"></span>  Add Prescription</a></li>
												<li><a href="<?= base_url('Doctor/print_slip/' . $t_patient['id'] . '/' . $t_patient['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>  Print Slip</a></li>
												<li><a href="<?= base_url('Doctor/add_today_patient_payment/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['apmt_id'] . '/' . $t_patient['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-rupee col_blu"></span>  Receive Payment</a></li>
												<li><a href="<?= base_url('Doctor/show_today_pat_final_pay/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['apmt_id'] . '/' . $t_patient['puid']); ?>" target="_blank" id="dotted_border"><span class=" fa fa-money "></span>   Clear Final Payment</a></li>
											...
											<?php elseif ($t_patient['status'] == 1) : ?>
												...
												<li><a href="<?= base_url('Doctor/change_today_patients_status/' . $t_patient['id'] . '/Admit'); ?>" id="dotted_border"><span class="fas fa-procedures col_blu"></span>  Admit Patient</a></li>
												<li><a href="<?= base_url('Doctor/print_slip/' . $t_patient['id'] . '/' . $t_patient['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>  Print Slip</a></li>
												<li><a href="<?= base_url('Doctor/add_today_patient_payment/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['apmt_id'] . '/' . $t_patient['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-rupee col_blu"></span>  Receive Payment</a></li>
												<li><a href="<?= base_url('Doctor/show_today_pat_final_pay/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['apmt_id'] . '/' . $t_patient['puid']); ?>" target="_blank" id="dotted_border"><span class=" fa fa-money "></span>   Clear Final Payment</a></li>
												<li><a href="<?= base_url('Doctor/add_today_hospital_expenses/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['apmt_id'] . '/' . $t_patient['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-h-square col_blu"></span>  Add Hospital Expenses</a></li>
											...
											<?php elseif ($t_patient['status'] == "Admission Processed") : ?>
												<li><a href="<?= base_url('Doctor/admit_today_patient/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['apmt_id'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial'] . '/' . $t_patient['doctor_id']); ?>" id="dotted_border" target="_blank"><span class="fas fa-procedures col_blu"></span> Admit Patient</a></li>
												<li><a href="<?= base_url('Doctor/add_today_pat_prescription/' . $t_patient['id']); ?>" id="dotted_border"><span class="fa fa-plus-square col_gren"></span>  Add Prescription</a></li>
												<!-- <li><a href="<//?= base_url('Doctor/add_today_patient_payment/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['apmt_id'] . '/' . $t_patient['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-rupee col_blu"></span>  Receive Payment</a></li>
												<li><a href="<//?= base_url('Doctor/show_today_pat_final_pay/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['apmt_id'] . '/' . $t_patient['puid']); ?>" target="_blank" id="dotted_border"><span class=" fa fa-money "></span>   Clear Final Payment</a></li> -->
												<li><a href="<?= base_url('Doctor/print_slip/' . $t_patient['id'] . '/' . $t_patient['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>  Print Slip</a></li>
						...
						<?php endforeach; ?>
					<?php else : ?>
						<h6 class="col_red">Patient Not Found</h6>
					<?php endif; ?>
					<tr>
						<td colspan="7">
