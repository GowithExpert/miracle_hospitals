			...
			<div class="col l8 m8 s12">
				<div class="card">
					...
					<div class="card-content">
						...
						<?= form_open('Doctor/save_admission_fee/' . $apmt_patient[0]->patients_id . '/' . $apmt_patient[0]->pid . '/' . $apmt_patient[0]->id . '/' . $apmt_patient[0]->puid . '/' . $apmt_patient[0]->serial ) ?>
						<div class="row">
							<div class="col l3 m3 s12">
								<label for="admission_fee">Admission Fee (INR)</label>
							</div>
							<div class="col l8 m8 s11">									
								<input type="number" name="admission_fee" id="admission_fee" class="plachldr_algn higt" placeholder="Enter Admission Fee" value=''>
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
								<div class="input-container">
									<input type="number" name="other_charges" class="asterisk over_error plachldr_algn higt" id="other_charges" placeholder="Enter Other charges" value=''>
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
							<div class="input-container">
								<input type="text" name="total_payable" class="asterisk over_error text_align readonly_bg plachldr_algn higt" id="total_payable" readonly  placeholder="Total payable" value="">
								<span class="asterisk-symbol">*</span>
							</div>
