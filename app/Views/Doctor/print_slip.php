		...
		<div class="card">
			...
			<div class="card-content">
				<div class="row">
					...
					<div class="col l12 m12 s12" id="brdr_botm_silvr">
						<div class="row">
							<div class="col l8 m8 s8">
								<h6>Patient Name : <span class="col_gren"><?= $patient_slip[0]->patient_name; ?></span>
								</h6>
							...
							<div class="col l4 m4 s4">
								...
								<!-- <h6>
									Doctor Fee : <//?= $patient_slip[0]->doc_fee; ?>
								</h6> -->
								<!-- <h6>
									Other Fee : <//?= $patient_slip[0]->other_cost; ?>
								</h6>
								<h6>
									Entry Fee : <//?= $patient_slip[0]->registration_fee; ?>
								</h6> -->
							</div>
						</div>
					</div>
				...
				<div class="card-content" id="brdr_botm_silvr">
					<!-- <h6>Payment Note : <//?= $patient_slip[0]->payment_note; ?> </h6> -->
