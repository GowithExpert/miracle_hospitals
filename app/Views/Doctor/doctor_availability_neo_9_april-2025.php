        ...
        */
        function populateSlotGrid() {
            ...
            if(!Array.isArray(availableSlots)) {
                ...
                var slotnum = 0;
                var order = 25; //6:00-06:16 ie 25th slot's order (1st start from 00:00-00-11 order)
                availableSlots.forEach(function(slot) {
                    ...
                    var slotElement ="";
                    if(st_hours_val <= cu_hours_val){ //} && st_minutes_val<= cu_minutes_val+15){
                    ...
                    if(slotnum === 72) { //72th slot means 23:45--00:00 ie 12 O'clock in night)
                        order = 1; 
                    }
