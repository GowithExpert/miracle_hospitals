	...
	<div class="container">
		<div class="card">
			...
			<div class="card-content"> 
				<?= form_open('Doctor/update_patients/'. $patients[0]->id, array('id' => 'registration_form', 'onsubmit' => 'return updateCountryCode();')); ?>
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12">
						<h6><span class="fa fa-user col_blu"></span> Name</h6>
						<div class="input-container">
							<input type="text" name="patient_name" id="input_box" class="asterisk" value="<?= $patients[0]->patient_name; ?>" />
