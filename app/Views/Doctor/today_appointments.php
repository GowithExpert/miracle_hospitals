	...
	<div class="equl_mrgn">
		...
		<div>
			...
			<div class="card-content" id="brdr_botm_silvr">
				<h5 class="h5_align"><span class="fa fa-calendar col_blu"></span>  Today's Patients Appointments</h5>
			</div>
			<div class="card-content" id="brdr_botm_silvr">
				<?php if ($today_appointments) : ?>
					...
					<div class="row">
						<div class="col l8 m8 s12">
							<?= form_open('Doctor/search_today_appointments'); ?>
							<ul id="search_doctor">
								<li>
						...
						<!-- <div class="col l1 m1 s1">
							...
							?>
								<h6 class="fa_eye col_red"><span class="fa fa-eye"></span>  <//?= $today_dis_patient; ?></h6>
							<//?php endif; ?>
						</div> -->
						<div class="col l4 m4 s12">
							...
							<ul class="dropdown-content" id="doctor_filter">
								<li><a href="<?= base_url('Doctor/filter_today_appointments/new_patient'); ?>" class="waves-effect brd_botm">
										<span class="fa fa-trophy col_blu"></span>  New Patients </a></li>
								<li><a href="<?= base_url('Doctor/filter_today_appointments/old_patient'); ?>" class="waves-effect">
			...
			<div class="scroll-container card-content">
				<table class="table">
					<tr class="backgrnd_colr_gray">
					 ...
					 <?php if (isset($today_appointments) && (is_array($today_appointments) || is_object($today_appointments))) :
						if (count($today_appointments) == 0) { ?> <h6 class="h5_inside">No record found</h6>
				<?php }
							...
							<td>
								...
								<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $t_patient['id']; ?>">
									...
									<?php if ($t_patient['status'] == 0) :  ?>
										...
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/1' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial'] . '/' . $t_patient['serial']); ?>" id="dotted_border"><span class="fa fa-calendar"></span>  Appointment</a></li>
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/3' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border"><span class="fa fa-hourglass-o"></span> Waiting</a></li> 
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/5' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border"><span class="fa fa-exclamation-triangle"></span> Absent</a></li>							
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/2' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" 	id="dotted_border" class="delete-today-appointment-link" style="color:red;"><span class="fa fa-trash col_red"></span> Delete</a></li>
									...
									<?php elseif ($t_patient['status'] == 1) : ?>
										...
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/3' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border"><span class="fa fa-hourglass-o"></span> Waiting</a></li>
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/5' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border"><span class="fa fa-exclamation-triangle"></span> Absent</a></li>
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/0' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" style="color:red;" id="dotted_border"><span class="fa fa-ban col_red"></span> Cancel</a></li>
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/2' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border" class="delete-today-appointment-link" style="color:red;"><span class="fa fa-trash col_red"></span> Delete</a></li>
												
									<?php elseif ($t_patient['status'] == "2") : ?>
										<!--0: Cancelled, 1: Appointment, 2: Deleted, 3: Awaited, 4: Attended, 5: Patient Not Reached, 6: View -->
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/1' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border"><span class="fa fa-calendar"></span> Appointment</a></li>
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/3' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border"><span class="fa fa-hourglass-o"></span> Waiting</a></li>
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/5' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border"><span class="fa fa-exclamation-triangle"></span> Absent</a></li>
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/0' . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" style="color:red;" id="dotted_border"><span class="fa fa-ban col_red"></span> Cancel</a></li>
										<li><a href="<?= base_url('Doctor/permanent_del_today_apmnt/' . $t_patient['id'] . '/' . $t_patient['pid'] . '/' . $t_patient['puid'] . '/' . $t_patient['serial']); ?>" id="dotted_border" class="permanent-delete-today-appointment-link" style="color:red;"><span class="fa fa-trash col_red"></span> Permanent Delete</a></li>
									...
									<?php else : ?>
										<li><a href="<?= base_url('Doctor/change_today_appointments_status/' . $t_patient['id'] . '/Appointment'); ?>" id="dotted_border"><span class="fa fa-calendar col_blu"></span> Appointment</a></li>
									<?php endif; ?>
								</ul>
								<!---Action Dropdown --->
								...
								<div id="deleteTodayAppointmentConfirmationModal" class="modal">
									<div class="modal-content">
										...
										<p class="del_pop_text">Are you sure you want to delete this today's appointment?</p>
								...
								<!-- Hidden permanent delete today patient confirmation modal -->
								<div id="permanentDeleteTodayPatientConfirmationModal" class="modal">
									<div class="modal-content">
										<span id="cancelPermanentDeleteTodayPatient" class="modal-icon cancel" onclick="hidePermanentDeleteTodayPatientConfirmationModal();">&#x2716;</span>
										<p class="del_pop_text">Are you sure you want to permanently delete this today's patient?</p>
										<div class="modal-buttons align_del_btn">
											<button id="confirmPermanentDeleteTodayPatient" class="modal-button delete">Permanent Delete</button>
										</div>
									</div>
								</div>
							</td>
		...
		<script>
			$(document).ready(function() {
				...
				var permanentDeleteTodayPatientUrl;

				$('.permanent-delete-today-patient-link').on('click', function(e) {
					e.preventDefault();
					permanentDeleteTodayPatientUrl = $(this).attr('href');

					// Show the custom permanent delete today patient confirmation modal
					$('#permanentDeleteTodayPatientConfirmationModal').show();
				});

				$('#cancelPermanentDeleteTodayPatient').on('click', function() {
					// Hide the custom permanent delete today patient confirmation modal when cancel is clicked
					$('#permanentDeleteTodayPatientConfirmationModal').hide();
				});

				$('#confirmPermanentDeleteTodayPatient').on('click', function() {
					// Perform the permanent deletion of today's patient and redirect
					window.location.href = permanentDeleteTodayPatientUrl;
				});
			});
			...
			function hideDeleteTodayAppointmentConfirmationModal() {
				...
				function hidePermanentDeleteTodayPatientConfirmationModal() {
			// Hide the custom permanent delete today patient confirmation modal when the modal close icon is clicked
			$('#permanentDeleteTodayPatientConfirmationModal').hide();
		}
