...
<body>
  ...
  <div class="container-fluid">
    ...
    <div id="ajx_sucess_msg"></div>
      ...
      <?= form_open_multipart('Doctor/add_hospital_expenses'); ?>
        <div class="container">
          <form id="productForm">
            <div class="row row_mrgn_tp">
              ...
              <div class="col-lg-1 col-md-1 col-sm-12">
                ...
                <div class="input-container">
                  <input type="text" class="input_area txt_rgt asterisk tax plcehldr_algn_lft higt" name="tax" id="tax" value="0" placeholder="Tax(%)">
                  <span class="asterisk-symbol">*</span>
              ...
              <div class="col-lg-1 col-md-1 col-sm-12">
                ...
                <div class="input-container">
                  <input type="text" class="input_area txt_rgt asterisk discount plcehldr_algn_lft higt" value="0" name="discount" id="discount" placeholder="Discount(%)" >
                  <span class="asterisk-symbol">*</span>
            ...
            <div class="row row_mrgn_tp">
              <div class="table-container scroll-container" id="tableContainer" style="display: none;">
                <div class="row" style="text-align:right; width:100%">
                  <h4><b>Total:</b> <span id="total"></span></h4>
                </div>
                <table id="data-table">
                  <thead>
                    <tr>
            ...
            <script>
              $(document).ready(function() {
                ...
                function saveToTable() { 
                  ...
                  $.ajax({
                    type: 'POST',
                    url: "<?= base_url('/Doctor/save_hospital_expenses') ?>",
                    data: {
                    ...
                    success: function(response) { 
                      if (response.status) {//status: true - Redirect to another page with success message
                       // console.log(response.status);
                        ...
                        //var a = totalPrice;
                        //alert(parseInt(Number(total)));//+parseInt(totalPrice));
                        $("#total").empty();
                        $("#total").text(parseFloat(Number(total))+parseFloat(totalPrice));
                      } 
