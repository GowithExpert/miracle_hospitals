			...
			<div class="col l8 m8 s12">
				...
				<div class="card">
					...
					<div class="card-content mrgn_top">
						...
						<?= form_open('Admin/add_received_payment/' . $get_patient[0]->patients_id . '/' . $get_patient[0]->pid . '/' . $get_patient[0]->id  . '/' . $get_patient[0]->puid,array('name' => 'add_patient_payment','onsubmit' => 'return(validate());')); ?>
						<!-- new code -->
						<div class="row">
							<div class="col l3 m3 s12">
							...
							<div class="col l8 m8 s11">									
								<?php 
								//echo "<pre>";
								//print_r($get_patient_final_payments['total_expnc_amt']); exit;
								//echo $get_patient_final_payments['total_expnc_amt'][0]->total_price;; exit;
								$total_expenses_value = $get_patient_final_payments['total_expnc_amt'][0]->total_price;
								$formatted_value = number_format($total_expenses_value, 2, '.', ''); // Format the value as a decimal with 2 decimal places
								?>
								<input type="number" name="total_hospital_expenses" class="readonly_bg plcehldr_lft" id="total_hospital_expenses" placeholder="Total Expense" readonly value="<?= $total_expenses_value === 0 ? '0.00' : $formatted_value; ?>">
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
								...
								$patient_paid_amount = number_format($get_patient_final_payments['total_payable'], 2, '.', ''); // Format the value as a decimal with 2 decimal places
								?>
								<div class="input-container">
									<input type="number" name="total_paid_amount" class="asterisk over_error readonly_bg plcehldr_lft" id="total_paid_amount" placeholder="Enter Total Patient Paid Amount" value="<?= $get_patient_final_payments['total_payable'] === 0 ? '0.00' : $patient_paid_amount; ?>" readonly>
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
								<div class="input-container">
									<input type="text" name="dues_amount" class="asterisk over_error inpt_pad readonly_bg plcehldr_lft" id="dues_amount" placeholder="0.00" value="<?= $get_patient_final_payments['total_pay_amt'][0]->paid_amount - $get_patient_final_payments['total_expnc_amt'][0]->total_price; ?>" readonly>
									<span class="asterisk-symbol">*</span>
								</div>
								<?php if (isset($validation)) { ?>
						...
						<div class="row">
							<div class="col l3 m3 s12">
								<label for="medicine_cost" id="receive_payment"> <span class="fa fa-rupee col_blu"></span> Receive Payment</label>
							</div>
							<div class="col l8 m8 s11">
								<div class="input-container">
									<input type="number" name="receive_payment" class="wp-form-control asterisk txt_rgt input-field receive_payment plcehldr" id="receive_payment" placeholder="Enter Receve Payment"  data-validation="Please enter receive payment">
						...
						<div class="row">
							<div class="col l3 m3 s12">
								<label for="medicine_cost" id="pay_mode1"> <span class="fa fa-rupee col_blu"></span> Pay Mode</label>
							</div>
							<div class="col l8 m8 s11">
								<div class="input-container">
									<!--
									...
									-->
									<select name="pay_mode" style="text-align:left" class="wp-form-control txt_rgt asterisk input-field pay_mode plcehldr" id="pay_mode" placeholder="Enter Doctor Fee"  onchange="validatePayMode()" >
						...
						<div class="row">
							<div class="col l3 m3 s12">
								<label for="medicine_cost" > <span class="fa fa-rupee col_blu"></span> Transaction ID</label>
							</div>
							<div class="col l8 m8 s11">
								<div class="input-container">
									<input type="text" name="transaction_id" class="wp-form-control  txt_rgt input-field transaction_id plcehldr" id="transaction_id" placeholder="Enter Transaction ID" data-validation="Please enter the transaction ID">
						...
						<div class="row">
							<div class="col l3 m3 s12">
								<label for="medicine_cost" id="payment_date"><span class="fa fa-rupee col_blu"></span> Payment Date</label>
							</div>
							<div class="col l8 m8 s11">
								<div class="input-container">
									<input type="text" value="<?php echo date('d-m-Y'); ?>" name="payment_date" class="wp-form-control txt_rgt input-field payment_date plcehldr" id="payment_date" placeholder="Payment Date" data-validation="Please enter the payment date">
