					...
					<div class="col l12 m12 s12">
						<div class="row">
							<div class="col l6 m6 s6">
								...
								<a href="tel:<?= $apmt_patient[0]->patient_name; ?>">
									<a href="tel:<?= $apmt_patient[0]->patient_mobile; ?>">
										<?= $apmt_patient[0]->doctor_name; ?></a>
									</h6>
							</div>
			...
			<div class="card-content" style="border-bottom: 1px dashed silver">
				<div class="row">
					<div class="col l6 m6  s6">
						...
						<h6 style="margin-bottom:  20px;">Appointment (Non-Refundable) Fee (INR)
						</h6>
