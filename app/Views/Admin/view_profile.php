...
<head>
    ...
    <!-- <script>
        <//?php //$profile_record->country_code = false; //HARD coded just for testing 
            if(!isset($profile_record->country_code) || $profile_record->country_code == '') {
            $profile_record->country_code = 'in';
        }?>
        var cntry_code = "<//?=$profile_record->country_code?>";    
    </script> -->
</head>
                        ...
                        <div class="card-body">
                            <div class="account-settings">
                                <div class="user-profile">
                                    <div class="user-avatar" id="avatar-container">
                                        ...
                                        <?php
											if (isset($profile_record->profile_pic) && !empty($profile_record->profile_pic)) {
												if (file_exists(FCPATH . 'uploads/accounts/admin/' . $profile_record->profile_pic)) { ?>
													<img src="<?= base_url() . 'public/uploads/accounts/admin/' . $profile_record->profile_pic; ?>" class="responsive-img" name="profile_pic" id="profile_pic">
                                    ...
                                    <h5 class="user-name" id="display_name" name="display_name"><?=$profile_record->full_name?></h5>
                            ...
                            <div class="row gutters">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    ...
                                    <div class="input-container">
                                        <input type="text" name="full_name" class="form-control asterisk user-email emailError fullName input_box" id="full_name" value="<?=$profile_record->full_name?>"placeholder="Enter Full Name">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="email" class="form-control asterisk user-email emailError eMail input_box" name="email" id="email"value="<?=$profile_record->email?>" placeholder="Enter email ID">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="tel" class="asterisk form-control phone-input phoneError phone phone_mandatory" name="mobile" maxlength="10" id="mobile" value="<?=$profile_record->mobile?>" placeholder="Enter phone number">
                                ...
                                <input type="hidden" id="country_code" name="country_code" value="<?=$profile_record->country_code?>">

                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        <label for="age">Gender</label>
                                        <div class="input-container">
                                            <input type="text" class="form-control asterisk ageError age input_box" name="gender" id="gender" value="<?=$profile_record->gender?>" placeholder="Enter Gender">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                            ...
                            <div class="row gutters">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="name" class="form-control asterisk streetError Street input_box" name="country" id="country" value="<?=$profile_record->country?>" placeholder="Enter Country">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="text" class="form-control asterisk stateError sTate input_box" name="state" id="state" value="<?=$profile_record->state?>" placeholder="Enter State">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="name" class="form-control asterisk cityError ciTy input_box" name="city" id="city" value="<?=$profile_record->city?>" placeholder="Enter City">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="text" class="form-control asterisk stateError sTate input_box" name="address" id="address" value="<?=$profile_record->address?>" placeholder="Enter Address">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                                    <span id="stateError" class="col_red"></span>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <div class="input-container">
                                            <input type="number" class="form-control asterisk pinError zIp input_box" name="pinzip" id="pinzip"value="<?=$profile_record->pinzip; ?>" placeholder="Enter Pin / Zip Code">
                                            <span class="asterisk-symbol">*</span>
						                </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control asterisk pinError zIp input_box" maxlength="120" name="about_me" id="about_me"value="<?=$profile_record->about_me?>" placeholder="Enter About Yourself" >
                                    </div>
    ...
    <script> 
        $(document).ready(function() {
            ...
            $("#browser_file").on("change", function () { //Upload pic on browse file
                ...
                $.ajax({
                    type: "POST",
                    url: "<?= base_url('/Admin/upload_profile_pic/') ?>",
                    data: formData,
                    contentType: false,
                    processData: false,
            ...
            function showsucesMsg(message) {
                ...
                $('#success-message').fadeIn().delay().fadeOut(function () {
                    // Display for 5 seconds, then reload the page
                    //location.reload(true);
                });
            }
