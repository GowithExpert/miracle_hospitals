	...
	<div class="equl_mrgn">
		...
		<div>
			...
			<div class="card-content" id="brdr_botm_silvr">
				<h5 class="font_weght"><span class="fa fa-image col_blu"></span> Manage Image Gallery</h5>
			</div>
			<?php if ($gallery) : ?>
				<div class="card-content" id="brdr_botm_silvr">
					...
					<div class="row">
						...
						<div class="col l2 m2 s2"> 
							<span class="right">
								<div class="tooltip"><a href="<?= base_url('Admin/image_gallery') ?>"><i class="fa fa-plus-circle plus_icon_mgt"></i></a>
									<span class="tooltiptext">Add Image</span>
								</div>
							</span>
						</div>
						<div class="col l2 m2 s10 mrgn_botm">
							<span class="right">
				...
				<div class="scroll-container card-content">
					<table class="table">
						...
						<?php if ($gallery) :
							...
							<?php endforeach; ?>
						<?php else : ?>
							<h6 class="h6_record col_red"> Gallery Record Not Found</h6>
						<?php endif; ?>
						<tr>
							<td colspan="7">
