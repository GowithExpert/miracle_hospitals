		...
		<div class="row">
			...
			<div class="col l8 m8 s12">
				...
				<div class="card">
					...
					<div class="card-content">
						<?= form_open('Admin/clear_final_dues/' . $patients[0]->id .'/'. $patients[0]->pid .'/'. $patients[0]->apmt_id .'/'. $patients[0]->puid . '/' .$patients[0]->status); ?>
						<!-- Start-Custom -->
						<div class="row">
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
							<div class="input-container">
								<input type="text" name="dues_amount" class="asterisk over_error inpt_pad readonly_bg plcehldr_lft" id="dues_amount" placeholder="0.00" value="<?= $total_pay_amt - $total_expnc_amt['total_expnc_amt']; ?>" readonly>
								<span class="asterisk-symbol">*</span>
							</div>
								<?php if (isset($validation)) { ?>
