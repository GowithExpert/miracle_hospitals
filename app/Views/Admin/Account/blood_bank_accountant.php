	...
	<div class="container">
		<div class="card">
			<div class="card-content" id="brdr_botm_silvr">
				<h5 class="dr_detil"><span class="fa fa-key col_blu"></span> Create Blood Bank Accountant </h5>
			...
			<?= form_open_multipart('Login/create_blood_acc', array('id' => 'registration_form', 'onsubmit' => 'return updateCountryCode();')); ?>
			...
			?>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12">
						<h6><span class="fa fa-user col_blu"></span> Blood Bank Accountant Name</h6>
						<div class="input-container">
							<input type="text" name="accountant_name" class="asterisk nameError" id="accountant_name" placeholder="Blood Bank Accountant Name" value="<?= set_value('accountant_name'); ?>">
							<span class="asterisk-symbol">*</span>
							<span id="nameError" class="col_red valid_err"></span>
						</div>
						<?php if (isset($validation)) { ?>
							<span class="col_red"><?= display_error($validation, 'accountant_name'); ?></span>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<h6><span class="fa fa-envelope col_blu"></span> Blood Bank Email</h6>
						<div class="input-container">
							<input type="text" name="email" class="asterisk emailInput" id="email" placeholder=" Blood Bank Email" value="<?= set_value('email'); ?>">
							<span class="asterisk-symbol">*</span>
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						...
						<div class="input-container">
							<input type="password" name="confirm_password" class="asterisk conf_password" id="input_box" placeholder="Confirm Password" value="<?= set_value('confirm_password'); ?>">
							<span class="asterisk-symbol">*</span>
		...
		$(document).ready(function() {
			...
			$("#btn_register_now").click(function(e) {
				...
				if (nameInput.val().trim() === "") {
					nameError.text("Please Enter The User Name");
					valid = false;
				} else {
					nameError.text("");
				}
