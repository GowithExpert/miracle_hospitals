	...
	<div class="equl_mrgn">
		...
		<div>
			...
			<div class="card-content" id="brdr_botm_silvr">
				<h5 class="font_weght"><span class="fa fa-medkit col_blu"></span> Manage Medical Accountant Account</h5>
			</div>
			<div class="card-content" id="brdr_botm_silvr">
				<?php if ($medical) : ?>
					...
					<div class="row">
						...
						<div class="col l2 m2 s2">
							<span class="right">
								<div class="tooltip"><a href="<?= base_url('Login/create_med_account'); ?>"><i class="fa fa-medkit med_icon" aria-hidden="true"></i></a>
									<span class="tooltiptext">Add Medical Account</span>
								</div>
							</span>
						</div>
						<div class="col l2 m2 s10">
							...
							<ul class="dropdown-content" id="doctor_filter">
								...
								<li><a href="<?= base_url('Admin/filter_med_account/new_med_acc'); ?>" class="waves-effect" id="dotted_border">
						...
						foreach ($medical as $doc) : ?>
							<tbody>
								<tr>
									<td class="txt_break-at300">
										...
										<a class="tooltipped" data-position="top" data-tooltip="<?= $doc['username']; ?>">
											...
											if (isset($doc['med_image']) && !empty($doc['med_image'])) {
												if (file_exists(FCPATH . 'uploads/Account/Accountant/' . $doc['med_image'])) { ?>
													<img src="<?= base_url() . 'public/uploads/Account/Accountant/' . $doc['med_image']; ?>" class="responsive-img" id="profile_pic" height="50">
									...
									<td class="txt_break-at300 txt_align">
										<a class="colour_hver" href="mailto:<?= $doc['email']; ?>"><?= $doc['email']; ?></a>
									</td>
									...
									<td class="txt_break-at300 txt_align_rgt">
										...
										<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $doc['id']; ?>" id="dotted_border">
											...
											<?php if ($doc['status'] == "Active") :  ?>
												<li><a href="<?= base_url('Admin/change_medical_acc_status/' . $doc['id'] . '/InActive'); ?>" id="dotted_border" style="color: red">
											...
											<?php elseif ($doc['status'] == "InActive") : ?>
												<li><a href="<?= base_url('Admin/change_medical_acc_status/' . $doc['id'] . '/Active'); ?>" id="dotted_border"><span class="fa fa-eye col_blu"></span> Active</a></li>
												<li><a href="javascript:void(0);" onclick="showDeleteConfirmationModal(<?= $doc['id']; ?>);" style="color:red;" id="dotted_border"><span class="fa fa-trash col_red"></span> Delete</a></li>

											<?php elseif ($doc['status'] == "Deleted") : ?>
												<li><a href="<?= base_url('Admin/change_medical_acc_status/' . $doc['id'] . '/Active'); ?>" id="dotted_border"><span class="fa fa-eye col_blu"></span> Active</a></li>
												<li><a href="<?= base_url('Admin/permanent_del_acc_account/' . $doc['id']); ?>" id="dotted_border" style="color:red;"><span class="fa fa-trash col_red"></span> Permanent Delete</a></li>
											<?php else : ?>
												<li><a href="<?= base_url('Admin/change_medical_acc_status/' . $doc['id'] . '/Active'); ?>" id="dotted_border"><span class="fa fa-eye col_blu"></span> Active</a></li>
											<?php endif; ?>
										</ul>
		...
		<script>
			$(document).ready(function() {
				...
				var basePath = 'manage_medical_acc';
			...
			function deleteItem(itemId) {
				window.location.href = "<?= base_url('Admin/delete_acc_account'); ?>/" + itemId + "/Deleted";
			}
