	...
	<div class="container">
		...
		<div class="row">
			<div class="col l7 m7 s12">
				...
				<div class="card">
					<div class="card-content" id="brdr_botm_silvr">
						<h5><span class="fa fa-image col_blu"></span>  Upload Front page Slider Image </h5>
					...
					<div class="card-content">
						...
						<div class="row">
							<div class="col l12 m12 s12">
								...
								<div class="input-container">
									<input type="file" name="image_gallery" class="imageError" id="input_file">
						...
						<div class="row">
							...
							<h6><span class="fa fa-link col_blu"></span> Website Link</h6>
								<input type="text" name="website_link" class="readonly_bg" id="input_box"  placeholder="Enter Website Link" readonly value="<?= base_url('Home/gallery')?>">
								<?php //if (isset($validation)) { ?>
									<span class="col_red"><//?= display_error($validation, 'website_link'); ?></span>
									<//?= $validation->listErrors(); ?>
								<?php //} ?>
							</div> -->
						</div>
						<h6><span class="fa fa-image col_blu"></span> Image Description</h6>
						<textarea name="image_discription" id="image_discription" placeholder="Enter Image Description">
					</textarea>
						<div class="row row12">
							<div class="col">
								<button type="submit" id="btn_register_now" class="btn waves-effect waves-light btn_hver sub_btn">Publish Slider Image</button>
							</div>
						</div>
						<?= form_close(); ?>
					</div>
			...
			<div class="col l5 m5 s12">
				...
				<div class="card">
					<div class="card-content">
						<h6 class="h6_gray_colr">Upload Image Guideline</h6>
						<h6 class="h6_gray_colr"><span class="fa fa-image col_ornge"></span> File Types <span class="right col_red">JPG-PNG-JPEG</span></h6>
						<h6 class="h6_gray_colr"><span class="fa fa-text-width col_ornge"></span> Image Size<span class="right col_red">500px(W) X 250px(H)</span></h6>
					</div>
				</div>
			</div>
		</div>
