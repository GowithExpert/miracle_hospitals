		...
		<div class="row">
			...
			<div class="col l8 m8 s12">
				...
				<div class="card">
					...
					<div class="card-content">
						<?= form_open('Admin/clear_revisit_final_dues/' . $revisit_patient[0]->id .'/'. $revisit_patient[0]->pid .'/'. $revisit_patient[0]->apmt_id .'/'. $revisit_patient[0]->puid . '/' .$revisit_patient[0]->status); ?>
						<!-- Start-Custom -->
						<div class="row">
						...
						<div class="row">
							...
							<div class="col l8 m8 s11">
							<div class="input-container">
								<input type="text" name="dues_amount" class="asterisk over_error inpt_pad readonly_bg plcehldr_lft" id="dues_amount" placeholder="0.00" value="<?= $total_pay_amt[0]->paid_amount - $total_expnc_amt[0]->total_price; ?>" readonly>
								<span class="asterisk-symbol">*</span>
							</div>
								<?php if (isset($validation)) { ?>
