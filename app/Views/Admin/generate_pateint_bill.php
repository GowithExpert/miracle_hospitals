...
<?php
$get_patient =  get_doctor_name('patients', $payment_bill[0]->patients_id);
?>
<!DOCTYPE html>
<html>
		...
		<div class="card" style="box-shadow: none;">
						...
						<div class="row">
							<div class="col l6 m6 s6">
								...
								<h6>Patient Mobile :
									...
									<a href="tel:<?= $get_patient[0]->patient_phone; ?>">
										<?= $get_patient[0]->patient_phone; ?></a>
								</h6>
								<h6>Patient Address : <?= $get_patient[0]->patient_address; ?>
			...
			<div class="card-content" style="border-bottom: 1px dashed silver">
				...
				<h6>
					...
					<?php
					echo $get_patient[0]->patient_issue;
					?>
