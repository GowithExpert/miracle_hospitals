	...
	<div style="margin-right: 15px; margin-left: 15px;">
		<div class="card" style="box-shadow: none;">
					...
					<div class="col l12 m12 s12">
						<div class="row">
							<div class="col l6 m6 s6">
								...
								<h6>Patient Mobile : <a href="tel:<?php if (is_array($patients)) {
																		if (isset($patients[0]['patient_phone'])) {
																			$patients[0]['patient_phone'];
																		}
																	} ?>"><?= $patients[0]['patient_mobile']; ?></a></h6>
								<h6>Booking Time : <?= date('h:i:s', strtotime($patients[0]['booking_time'])); ?></h6>

							</div>
							<div class="col l6 m6 s6" style="text-align: center;">
								<h6>Admit Date :
									<?= date('d M, Y', strtotime($patients[0]['created_at'])); ?>
								</h6>
			...
			<div class="card-content" style="border-bottom: 1px dashed silver">
				<h5 style="font-weight: 500;font-size: 18px;">Disease and Symptoms : <span style="color: red;font-weight: 500"><?= $patients[0]['disease_symptoms']; ?></span></h5>

			</div>
			<div class="card-content">

				<?= form_open('Admin/add_appointment_pat_charge/' . $patients[0]['id']); ?>
				<div class="row">
