...
<body>
	...
	<div class="equl_mrgn">
		...
		<div>
			...
			<div class="card-content" id="brdr_botm_silvr">
				...
				<h5 class="font_weght"><span class="fa fa-tasks col_blu"></span> Manage Department</h5>
			</div>
			<div class="card-content" id="brdr_botm_silvr">
				<?php if ($department) : ?>
					...
					<div class="row">
							...
							<ul id="search_doctor">
								<li>
									<div class="input-container">
										<input type="text" name="department_name" class="serch_area" id="input_box" value="<?= set_value('department_name'); ?>" placeholder="Enter Department Name" required="">
						...
						<div class="col l2 m2 s2">
							<span class="right">
								<div class="tooltip"><a href="<?= base_url('Admin/add_department') ?>"><i class="fa fa-plus-circle plus_icon_mgt"></i></a>
						...
						<div class="col l2 m2 s10">
							<span class="right">
								<button type="button" class="btn waves-effect waves-light dropdown-trigger btn_hver filter_btn" data-target="doctor_filter">
									<span class="fa fa-filter"></span> Filter Department
								</button>
							</span>
							<!---Student filter -->
							<ul class="dropdown-content" id="doctor_filter">

								<li><a href="<?= base_url('Admin/filter_department/new_department'); ?>" id="dotted_border"><span class="fa fa-tasks col_blu"></span> New Department </a></li>
								<li><a href="<?= base_url('Admin/filter_department/old_department'); ?>" class="waves-effect">
										<span class="fa fa-tasks col_blu"></span> Old Department </a></li>
							</ul>
						</div>
				...
				<div class="table-container">
					<table class="table">
						...
						<?php if ($department) :
							...
							foreach ($department as $doc_fee) : ?>
								...
								<tbody>
									<tr>
										...
										<td class="text-container_depart depart_widh">
										...
										<td>
											...
											<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $doc_fee['id']; ?>">
												<li><a href="<?= base_url('Admin/edit_department/' . $doc_fee['id']); ?>" id="dotted_border" style="color:#26a69a;"><span class="fa fa-edit col_blu"></span> Edit</a></li>

												<?php if ($doc_fee['status'] == "Active") :  ?>
													<li><a href="<?= base_url('Admin/change_department_status/' . $doc_fee['id'] . '/InActive'); ?>" id="dotted_border" style="color:red ;">
												...
												<?php elseif ($doc_fee['status'] == "InActive") : ?>
													<li><a href="<?= base_url('Admin/change_department_status/' . $doc_fee['id'] . '/Active'); ?>" id="dotted_border" style="color:#26a69a;"><span class="fa fa-eye col_blu"></span> Active</a></li>
													<li><a href="javascript:void(0);" onclick="showDeleteConfirmationModal(<?= $doc_fee['id']; ?>);" id="dotted_border" style="color:red ;"><span class="fa fa-trash col_red"></span> Delete</a></li>

												<?php elseif ($doc_fee['status'] == "Deleted") : ?>
													<!-- Permanent Delete link -->
													<li><a href="javascript:void(0);" class="permanent-delete-link" style="color: red;" onclick="showPermanentDeleteConfirmationModal(<?= $doc_fee['id']; ?>)" id="dotted_border"><span class="fa fa-trash col_red"></span> Permanent Delete</a></li>
							...
							<?php endif; ?>
						<?php else : ?>
							<h6 class="col_red">Department Record Not Found</h6>
						<?php endif; ?>
						<tr>
							<td colspan="7">
	...
	<script>
		$(document).ready(function() {
			...
			var basePath = 'manage_department';
...
////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		function deleteItem(itemId) {
			...
			window.location.href = "<?= base_url('Admin/delete_department'); ?>/" + itemId + "/Deleted";
		}
		...
		function permanentDeleteItem(itemId) {
			...
			window.location.href = "<?= base_url('Admin/permanent_del_department'); ?>/" + itemId + "/Permanent Deleted";
		}
