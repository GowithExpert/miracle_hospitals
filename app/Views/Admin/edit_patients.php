	...
	<div class="container">
		<div class="card">
			<div class="card-content" id="brdr_botm_silvr">
				<h5><span class="fa fa-wheelchair col_blu"></span> Edit Patients Details</h5>
			</div>
			<div class="card-content"> 
				<?= form_open('Admin/update_patients/'. $patients[0]->id, array('id' => 'registration_form', 'onsubmit' => 'return updateCountryCode();')); ?>
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-12">
						<div class="input-container">
							...
							<input type="tel" name="patient_phone" class="phone-input phone_mandatory" id="input_box" maxlength="10" value="<?= $patients[0]->patient_phone; ?>">
						</div>
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12">
						...
						<input type="text" name="patient_issue" id="input_box" value="<?= $patients[0]->patient_issue; ?>" class="readonly_bg" readonly>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
