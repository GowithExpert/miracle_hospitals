				...
				<?php if ($revisited_patients) : ?>
					...
					<div class="row">
						<div class="col l8 m8 s12">
							<?= form_open('Admin/search_results'); ?>
							<ul id="search_doctor">
								<li>
						...
						<div class="col l2 m2 s10">
							...
							<ul class="dropdown-content" id="doctor_filter">
								<li><a href="<?= base_url('Admin/filter_revisit_patient/new_patients'); ?>" class="waves-effect" id="dotted_border">
										<span class="fa fa-wheelchair col_blu"></span> New Revisit Patient </a></li>
								<li><a href="<?= base_url('Admin/filter_revisit_patient/old_patients'); ?>" class="waves-effect">
			...
			<div class="scroll-container card-content">
				<table class="table">
					...
					<?php if (isset($revisited_patients)) :
						...
						foreach ($revisited_patients as $rev_pat_rec) : ?>
							<tr>
								<td>
									<center>
								...
								<td>
									...
									<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $rev_pat_rec['id']; ?>">
										...
										<?php elseif ($rev_pat_rec['status'] == "Admission Processed") : ?>
											<li><a href="<?= base_url('Admin/admit_revisit_patient/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid'] . '/' . $rev_pat_rec['serial'] . '/' . $rev_pat_rec['doctor_id']); ?>" id="dotted_border" target="_blank"><span class="fas fa-procedures col_blu"></span> Admit Patient
										
										</a></li>
											<li><a href="<?= base_url('Admin/add_revisit_prescription/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid']); ?>" id="dotted_border"><span class="fa fa-plus-square col_gren"></span> Update Prescription</a></li>
											<li><a href="<?= base_url('Admin/add_revisit_patient_payment/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-rupee col_blu"></span> Receive Payment</a></li>
											<li><a href="<?= base_url('Admin/show_revisit_patient_final_payments/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid']); ?>" target="_blank" id="dotted_border"><span class=" fa fa-money"></span>  Clear Final Payment</a></li>
											<li><a href="<?= base_url('Admin/edit_revisit_patients/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid']); ?>" id="dotted_border"> <span class="fa fa-edit col_blu"></span>  Edit</a></li>
											<li><a href="<?= base_url('Admin/print_slip/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>  Print Slip</a></li>
											<li><a href="<?= base_url('Admin/add_revisit_hospital_expenses/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-h-square col_blu"></span> Add Hospital Expenses</a></li>
										...
										<?php elseif ($rev_pat_rec['status'] == "Prescribed") : ?>
											<li><a href="<?= base_url('Admin/admit_revisit_patient/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid'] . '/' . $rev_pat_rec['serial'] . '/' . $rev_pat_rec['doctor_id']); ?>" id="dotted_border" target="_blank"><span class="fas fa-procedures col_blu"></span> Admit Patient</a></li>
											<li><a href="<?= base_url('Admin/add_revisit_patient_payment/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-rupee col_blu"></span> Receive Payment</a></li>
											<li><a href="<?= base_url('Admin/edit_revisit_patients/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid']); ?>" id="dotted_border"> <span class="fa fa-edit col_blu"></span>  Edit</a></li>
											<li><a href="<?= base_url('Admin/print_slip/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>  Print Slip</a></li>
											<li><a href="<?= base_url('Admin/show_revisit_patient_final_payments/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid']); ?>" target="_blank" id="dotted_border"><span class=" fa fa-money "></span>  Clear Final Payment</a></li>
										...
										<?php elseif ($rev_pat_rec['status'] == "Discharge Summary") : ?>
											...
											<li><a href="<?= base_url('Admin/edit_revisit_patients/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid']); ?>" id="dotted_border"> <span class="fa fa-edit col_blu"></span>  Edit</a></li>
											<li><a href="<?= base_url('Admin/print_slip/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>  Print Slip</a></li>
											<li><a href="<?= base_url('Admin/add_revisit_patient_payment/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/Discharge Processed'); ?>" id="dotted_border" style="color:red"><span class=" fa fa-wheelchair col_red"></span>  Discharge Processed</a></li>
											<li><a href="<?= base_url('Admin/show_revisit_patient_final_payments/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid']); ?>" target="_blank" id="dotted_border"><span class=" fa fa-money "></span>  Clear Final Payment</a></li>
											<li><a href="<?= base_url('Admin/delete_revisit_patients/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid']); ?>" id="dotted_border" class="delete-patient-link" style="color:red;">
												<span class="fa fa-trash col_red"></span>  Delete	</a></li>
														
										<?php elseif ($rev_pat_rec['status'] == "Deleted") : ?>
											<!-- added if condition if doctor id is empty 4 mar 2025 -->
											<?Php if(!empty($rev_pat_rec['doctor_id'])){ ?>
											<li><a href="<?= base_url('Admin/admit_revisit_patient/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid'] . '/' . $rev_pat_rec['serial'] . '/' . $rev_pat_rec['doctor_id']); ?>" id="dotted_border" target="_blank"><span class="fas fa-procedures col_blu"></span> Re-Admit Patient</a></li>
											<?php } ?>
											<li><a href="<?= base_url('Admin/edit_revisit_patients/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid']); ?>" id="dotted_border"> <span class="fa fa-edit col_blu"></span>  Edit</a></li>
											<li><a href="<?= base_url('Admin/print_slip/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-print col_blu"></span>  Print Slip</a></li>
											...
											<li><a href="<?= base_url('Admin/show_revisit_patient_final_payments/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid']); ?>" target="_blank" id="dotted_border"><span class=" fa fa-money "></span>  Clear Final Payment</a></li>
											<li><a href="<?= base_url('Admin/change_revisit_patients_status/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/Discharged'); ?>" id="dotted_border" style="color:red"><span class="fa fa-eye-slash col_red"></span>  Discharge</a></li> 		
											<li><a href="<?= base_url('Admin/permanent_del_revisit_patients/' . $rev_pat_rec['id']); ?>" 
										...
										<?php elseif ($rev_pat_rec['status'] == "Attended") : ?>
											<!-- <li><a href="<//?= base_url('Admin/admit_revisit_patient/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid'] . '/' . $rev_pat_rec['serial'] . '/' . $rev_pat_rec['doctor_id']); ?>" id="dotted_border" target="_blank"><span class="fas fa-procedures" style="color: #005197"></span> Admit Patient</a></li> -->
											<!-- <li><a href="<//?//= base_url('Admin/get_dept_for_rev_admission/'. $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['puid'] . '/' . $rev_pat_rec['apmt_id']); ?>" id="dotted_border"><span class="fas fa-procedures col_blu"></span> Admission Process</a></li> -->
											<li><a href="<?= base_url('Admin/get_dept_for_rev_admission/'. $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['puid'] . '/' . $rev_pat_rec['apmt_id']. '/' . $rev_pat_rec['serial'] . '/' . $rev_pat_rec['doctor_id']); ?>" id="dotted_border"><span class="fas fa-procedures col_blu"></span> Admission Process</a></li>
											<!-- <li><a href="<//?= base_url('Admin/get_dept_for_admission/'. $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['puid'] . '/' . $rev_pat_rec['apmt_id']. '/' . $rev_pat_rec['serial'] . '/' . $rev_pat_rec['doctor_id']); ?>" id="dotted_border"><span class="fas fa-procedures col_blu"></span> Admission Process</a></li> -->
											<li><a href="<?= base_url('Admin/add_revisit_prescription/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid']); ?>" id="dotted_border">
										...
										<?php elseif ($rev_pat_rec['status'] == "Dues Cleared") : ?>
											<li><a href="<?= base_url('Admin/change_revisit_patients_status/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/Discharged'); ?>" id="dotted_border" style="color:red"><span class="fa  fa-eye-slash col_red"></span> Discharge</a></li>
											<li><a href="<?= base_url('Admin/admit_revisit_patient/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid'] . '/' . $rev_pat_rec['serial'] . '/' . $rev_pat_rec['doctor_id']); ?>" id="dotted_border" target="_blank"><span class="fas fa-procedures col-blu"></span> Admit Patient</a></li>
											<li><a href="<?= base_url('Admin/add_revisit_prescription/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid']); ?>" id="dotted_border">
											...
											<li><a href="<?= base_url('Admin/add_revisit_hospital_expenses/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/' . $rev_pat_rec['apmt_id'] . '/' . $rev_pat_rec['puid']); ?>" id="dotted_border" target="_blank"><span class="fa fa-h-square col_blu"></span> Add Hospital Expenses</a></li>
										<?php else : ?>
											<li><a href="<?= base_url('Admin/change_revisit_patients_status/' . $rev_pat_rec['id'] . '/' . $rev_pat_rec['pid'] . '/Admit'); ?>" id="dotted_border;"><span class="fas fa-procedures col_blu"></span> Admit</a></li>
										<?php endif; ?>
									</ul>
