	...
	<div class="equl_mrgn">
		...
		<div>
			...
			<div class="card-content" id="brdr_botm_silvr">
				<h5 class="font_weght"><span class="fa fa-user-md col_blu"></span> Manage Doctor</h5>
			</div>
			<div class="card-content" id="brdr_botm_silvr">
					...
					<div class="row">
						...
						<div class="col l2 m2 s10">
							...
							<ul class="dropdown-content" id="doctor_filter">
								...
								<li><a href="<?= base_url('Admin/filter_doctor/new_doctor'); ?>" class="waves-effect" id="dotted_border"><span class="fa fa-users col_blu"></span> New Doctor </a></li>
								<li><a href="<?= base_url('Admin/filter_doctor/old_doctor'); ?>" class="waves-effect"><span class="fa fa-users col_blu" ></span> Old Doctor </a></li>
							</ul>
						</div>
			...
			<div class="scroll-container card-content tble_alignment">
				<table class="table">
					<tr class="backgrnd_colr_gray">
						<th class="txt_align">Pic</th> <!-- photo -->
						<th class="txt_align">Dr. Name</th>
						<th class="txt_align">Degree</th>
						<th class="txt_align">Specialization</th>
						...
						foreach ($doctors as $doc) : ?>
							<tbody>
								<tr>
									...
									<td class="txt_break-at200 text-container_mange_doc txt_align">
										<?= $doc['doctor_name']; ?>
									</td>
									...
									<td class="text-container_mange_doc txt_align">
										<span class="break-word">
											<a class="link_hver txt_align" href="mailto:<?= $doc['doctor_email']; ?>"><?= $doc['doctor_email']; ?></a>
										</span>
									</td>
									<td class="txt_break-at300">
										<a class="link_hver txt_align" id="phoneNumber" href="tel:<?= $doc['doctor_phone']; ?>"> <?= $doc['doctor_phone']; ?></a>
									</td>
									<td class="text-container_mange_doc txt_align">
										<span class="break-word txt_align">
											<?= $doc['doctor_address']; ?>
										</span>
									</td>
									<td class="txt_break-at300 txt_align">
									...
									<td class="txt_break-at300 txt_align">
										...
										elseif ($doc['status'] == "Permanent Deleted") :
									...
									<td>
										...
										<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $doc['id']; ?>">
											<li><a href="<?= base_url('Admin/edit_doctor/' . $doc['id']); ?>" id="dotted_border"><span class="fa fa-edit col_blu"></span> Edit</a></li>

											<?php if ($doc['status'] == "Active") :  ?>

												<li><a href="<?= base_url('Admin/change_doctor_status/' . $doc['id'] . '/InActive'); ?>" id="dotted_border" style="color:red;"><span class="fa fa-eye-slash col_red"></span> InActive</a></li>		
												<li><a href="javascript:void(0);" onclick="showDeleteConfirmationModal(<?= $doc['id']; ?>);" style="color:red;" id="dotted_border"><span class="fa fa-trash col_red"></span> Delete</a></li>

											<?php elseif ($doc['status'] == "InActive") : ?>

												<li><a href="<?= base_url('Admin/change_doctor_status/' . $doc['id'] . '/Active'); ?>" id="dotted_border"><span class="fa fa-eye col_blu"></span> Active</a></li>
												<li><a href="javascript:void(0);" onclick="showDeleteConfirmationModal(<?= $doc['id']; ?>);" style="color:red;" id="dotted_border"><span class="fa fa-trash col_red"></span> Delete</a></li>

											<?php elseif ($doc['status'] == "Deleted") : ?>
												
												<li><a href="<?= base_url('Admin/change_doctor_status/' . $doc['id'] . '/Active'); ?>" id="dotted_border"><span class="fa fa-eye col_blu"></span> Active</a></li>
												<li><a href="javascript:void(0);" style="color:red;" class="permanent-delete-link" onclick="showPermanentDeleteConfirmationModal(<?= $doc['id']; ?>)" id="dotted_border"><span class="fa fa-trash" style="color: red"></span> Permanent Delete</a></li>
										...
										<div id="deleteConfirmationModal" class="modal">
											<div class="modal-content">
												...
												<p class="del_pop_text">Are you sure you want to delete this Doctor?</p>
		...
		<script>
			...
			function deleteItem(itemId) {
				...
				window.location.href = "<?= base_url('Admin/delete_doctor'); ?>/" + itemId + "/Deleted";
			}
			...
			function permanentDeleteItem(itemId) {
				...
				window.location.href = "<?= base_url('Admin/permanent_del_doctor'); ?>/" + itemId + "/Permanent Deleted";
			}
