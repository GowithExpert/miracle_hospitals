			...
			<div class="col l8 m8 s12">
				<div class="card">
					...
					<div class="card-content mrgn_top">
						...
						<!-- <//?= form_open('Admin/add_patient_payment/' . $get_patient[0]->patients_id . '/' . $get_patient[0]->pid . '/' . $get_patient[0]->id  . '/' . $get_patient[0]->puid); ?> -->
						<?= form_open('Admin/add_received_payment/' . $get_patient[0]->patients_id . '/' . $get_patient[0]->pid . '/' . $get_patient[0]->id  . '/' . $get_patient[0]->puid); ?>
						<div class="row">
							<div class="col l12 m12 s12">
								...
								<div class="input-container">
									...
									<span class="validation valid_err1 col_red"></span>
								</div>
						...
						<div class="row">
							<div class="col l12 m12 s12">
								...
								<div class="input-container">
									<input type="number" name="doc_fee" class="wp-form-control txt_rgt asterisk input-field doctor_fee plcehldr" id="input_box" placeholder="Enter Doctor Fee" required data-validation="Please enter the valid doctor fees">
									<span class="asterisk-symbol asterisk-symbol1">*</span>
									<span class="validation valid_err1 col_red"></span>
								</div>
								<?php if (isset($validation)) { ?>
