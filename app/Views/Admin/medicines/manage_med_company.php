...
<head>
	<title>Manage Medicines Company</title>
	...
	<div class="equl_mrgn">
		...
		<div>
			...
			<div class="card-content" id="brdr_botm_silvr">
				<h5 class="font_weght"><span class="fa fa-medkit col_blu"></span> Manage Medicines Company</h5>
			</div>
			<div class="card-content" id="brdr_botm_silvr">
				<?php if ($med_category) : ?>
					...
					<div class="row">
						<div class="col l8 m8 s12">
							<?= form_open('Admin/search_medicines_company'); ?>
							<ul id="search_doctor">
								<li>
									<div class="input-container">
										<input type="text" name="medicine_name" class="serch_area" id="input_box" value="<?= set_value('medicine_name'); ?>" placeholder="Enter Company Name" required="">
						...
						<div class="col l2 m2 s2">
							<span class="right">
								<div class="tooltip"><a href="<?= base_url('Admin/add_med_company'); ?>"><i class="fa fa-medkit med_icon" aria-hidden="true"></i></a>
									<span class="tooltiptext">Add Medicine Company</span>
								</div>
							</span>
						</div>
						<div class="col l2 m2 s10">
							...
							<ul class="dropdown-content" id="doctor_filter">
								...
								<li><a href="<?= base_url('Admin/filter_medicine_com/new_com'); ?>" class="waves-effect" id="dotted_border">
										<span class="fa fa-medkit col_blu"></span> New Medicine Category</a>
								</li>
								<li><a href="<?= base_url('Admin/filter_medicine_com/old_com'); ?>" class="waves-effect">
								...
								<tr>
									<td class="txt_break-at300">
										...
										<a class="tooltipped" data-position="top" data-tooltip="<?= $doc['company_name']; ?>">
											<img src="<?= base_url() . 'public/uploads/medicine_company/' . $doc['company_image']; ?>" class="responsive-img" id="profile_pic" height="50">
										</a>
									...
									<td class="txt_break-at300 txt_align_rgt">
										...
										<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $doc['id']; ?>">
											<li><a href="<?= base_url('Admin/edit_med_company/' . $doc['id']); ?>" id="dotted_border"><span class="fa fa-edit col_blu"></span> Edit</a></li>

											<?php if ($doc['status'] == "Active") :  ?>
												<li><a href="<?= base_url('Admin/change_med_com_status/' . $doc['id'] . '/InActive'); ?>" id="dotted_border">
											...
											<?php elseif ($doc['status'] == "InActive") : ?>
												<li><a href="<?= base_url('Admin/change_med_com_status/' . $doc['id'] . '/Active'); ?>" id="dotted_border"><span class="fa fa-eye col_blu"></span> Active</a></li>
												<li><a href="javascript:void(0);" onclick="showDeleteConfirmationModal(<?= $doc['id']; ?>);" id="dotted_border" style="color:red;"><span class="fa fa-trash col_red"></span> Delete</a></li>

											<?php elseif ($doc['status'] == "Deleted") : ?>
												<li><a href="<?= base_url('Admin/change_med_com_status/' . $doc['id'] . '/Active'); ?>" id="dotted_border"><span class="fa fa-eye col_blu"></span> Active</a></li>
												<li><a href="<?= base_url('Admin/permanent_del_med_com/' . $doc['id']); ?>" id="dotted_border" class="permanent-delete-appointment-link" style="color:red;"><span class="fa fa-trash col_red"></span> Permanent Delete</a></li>
		...
		<script>
			...
			$(document).ready(function() {
				...
				var basePath = 'manage_med_company';
			...
			function deleteItem(itemId) {
				window.location.href = "<?= base_url('Admin/delete_med_com'); ?>/" + itemId + "/Deleted";
			}
