...
<head>
	<title>Add Medicines Category</title>
	<?= helper('Form'); ?>
	<!---CSS File Include  -->
	...
	<div class="container">
		<div class="card">
			<div class="card-content" id="brdr_botm_silvr">
				<h5><span class="fa fa-medkit col_blu"></span> Add Medicines Category</h5>
			...
			<div class="card-content">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 -col-sm-12">
						<h6><span class="far fa-building col_blu"></span> Medicines Category Name</h6>
						
						<div class="input-container">
							<input type="text" name="category_name" class="asterisk nameError" id="input_box" placeholder="Add Medicines Cagetory Name" value="<?= set_value('category_name'); ?>">
							<span class="asterisk-symbol">*</span>
							<span id="nameError" class="col_red valid_err"></span>
						</div>
						<?php if (isset($validation)) { ?>
							<span class="col_red"><?= display_error($validation, 'category_name'); ?></span>
							<?= $validation->listErrors(); ?>
						<?php } ?>

					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
						<h6><span class="fas fa-capsules col_blu"></span> Category Image</h6>
						<div class="input-container">
				...
				<div class="row row12">
					<div class="col">
						<button type="submit" id="btn_register_now" class="btn btn-waves-effect waves-light btn_hver sub_btn"><span class="far fa-building"></span> Add Category</button>
					</div>
				</div>
				<?= form_close(); ?>
