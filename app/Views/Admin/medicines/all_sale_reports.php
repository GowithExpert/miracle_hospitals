...
<body>
	...
	<div class="card" style="box-shadow: none;margin-right: 15px;margin-left: 15px;">
		<div class="card-content" style="border-bottom: 1px solid silver;padding: 5px;">
			<h5 style="font-weight: 500;margin-top: 5px; font-size: 20px; font-family: Arial, sans-serif;"><span class="fa fa-flask col_blu"></span> Manage Sales <span class="right"><a href="#!" class="modal-trigger txt_hver" data-target="customize_sale_modal" style="font-size: 15px;font-weight: 500;">
		</div>
			...
			<?php if ($sales) : ?>
				...
				<div class="modal" id="customize_sale_modal">
					<div class="modal-content" style="padding: 10px;border-bottom: 1px solid silver;">
						<h6 style="font-size: 15px;color: grey;font-weight: 500;"><span class="fa fa-filter"></span> Customize Sales Report<span class="close-modal" style="float: right; cursor: pointer;" onclick="closeModal()">&times;</span></h6>
					</div>
