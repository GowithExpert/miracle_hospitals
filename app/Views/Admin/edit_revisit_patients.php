	...
	<div class="container">
		<div class="card">
			...
			<div class="card-content"> 
				<?= form_open('Admin/update_revisit_patients/'. $revisit_patients[0]->pid, array('id' => 'registration_form', 'onsubmit' => 'return updateCountryCode();')); ?>
				<div class="row">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-12">
						...
						<input type="text" name="disease_symptoms" id="input_box" value="<?= $revisit_patients[0]->disease_symptoms; ?>" class="readonly_bg" readonly>
					</div>
					<div class="col-lg-6 col-md-6 col-sm-12">
