g<!-- Copyright © 2023-2024 Neoark Software Pvt Ltd. All rights reserved.
...
<head>
	<title>Manage Today's Discharged Patients</title>
...
<body>
	...
	<div class="equl_mrgn">
		...
		<div>
			...
			<div class="card-content" id="brdr_botm_silvr">
				<h5 class="font_weght"><span class="fa fa-wheelchair col_blu"></span> Manage Today's Discharged Patients</h5>
			</div>
			<div class="card-content" id="brdr_botm_silvr">
				<?php if (($patients)) : ?>
					...
					<div class="row">
						...
						<div class="col l2 m2 s10">
							...
							<ul class="dropdown-content" id="doctor_filter">
								...
								<li><a href="<?= base_url('Admin/filter_dischrage_patient/new_patients'); ?>" class="waves-effect" id="dotted_border">
										<span class="fa fa-wheelchair col_blu"></span> New Patients </a></li>
								<li><a href="<?= base_url('Admin/filter_dischrage_patient/old_patients'); ?>" class="waves-effect">
							...
							<tr>
								...
								<td>
									...
									<ul class="dropdown-content action_dropdown" id="action_dropdown_<?= $pat_rec['id']; ?>">
										<li><a href="<?= base_url('Admin/payment_dischrge_patient/' .  $pat_rec['id'] . '/' . $pat_rec['pid'] . '/' . $pat_rec['apmt_id'] . '/' . $pat_rec['puid']); ?>" target="" id="dotted_border"><span class="fa fa-rupee col_gren"></span> View Payment</a></li>
										...
										<li><a href="<?= base_url('Admin/change_today_discharged_patient_status/' . $pat_rec['id'] . '/Active'); ?>" id="dotted_border"><span class="fas fa-procedures col_blu"></span> Admit</a></li>
										<li><a href="javascript:void(0);" onclick="showDeleteConfirmationModal(<?= $pat_rec['id']; ?>);" id="dotted_border" style="color: red;" target=""><span class="fa fa-trash col_red"></span> Delete</a></li>
									</ul>
									...
									<div id="deleteConfirmationModal" class="modal">
										<div class="modal-content">
											...
											<p class="del_pop_text">Are you sure you want to delete this Discharge Patient?</p>
	...
	<script>
		$(document).ready(function() {
			...
			var basePath = 'manage_today_discharged_patient';
		...
		function deleteItem(itemId) {
			window.location.href = "<?= base_url('Admin/delete_today_dis_patients'); ?>/" + itemId + "/Deleted";
		}
